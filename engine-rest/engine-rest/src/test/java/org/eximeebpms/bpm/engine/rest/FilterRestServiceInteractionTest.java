...
import static org.eximeebpms.bpm.engine.authorization.Permissions.DELETE;
import static org.eximeebpms.bpm.engine.authorization.Permissions.READ;
import static org.eximeebpms.bpm.engine.authorization.Permissions.UPDATE;
import static org.eximeebpms.bpm.engine.authorization.Resources.FILTER;
...
import static org.eximeebpms.bpm.engine.rest.dto.task.TaskQueryDto.SORT_BY_EXECUTION_ID_VALUE;
import static org.eximeebpms.bpm.engine.rest.dto.task.TaskQueryDto.SORT_BY_EXECUTION_VARIABLE;
import static org.eximeebpms.bpm.engine.rest.dto.task.TaskQueryDto.SORT_BY_FOLLOW_UP_VALUE;
import static org.eximeebpms.bpm.engine.rest.dto.task.TaskQueryDto.SORT_BY_ID_VALUE;
import static org.eximeebpms.bpm.engine.rest.dto.task.TaskQueryDto.SORT_BY_NAME_CASE_INSENSITIVE_VALUE;
import static org.eximeebpms.bpm.engine.rest.dto.task.TaskQueryDto.SORT_BY_NAME_VALUE;
import static org.eximeebpms.bpm.engine.rest.dto.task.TaskQueryDto.SORT_BY_PRIORITY_VALUE;
import static org.eximeebpms.bpm.engine.rest.dto.task.TaskQueryDto.SORT_BY_PROCESS_INSTANCE_ID_VALUE;
import static org.eximeebpms.bpm.engine.rest.dto.task.TaskQueryDto.SORT_BY_PROCESS_VARIABLE;
import static org.eximeebpms.bpm.engine.rest.dto.task.TaskQueryDto.SORT_BY_TASK_VARIABLE;
import static org.eximeebpms.bpm.engine.rest.dto.task.TaskQueryDto.SORT_BY_TENANT_ID_VALUE;
import static org.eximeebpms.bpm.engine.rest.helper.MockProvider.EXAMPLE_FILTER_ID;
import static org.eximeebpms.bpm.engine.rest.helper.MockProvider.mockFilter;
import static org.eximeebpms.bpm.engine.rest.helper.MockProvider.mockVariableInstance;
import static org.eximeebpms.bpm.engine.rest.helper.TaskQueryMatcher.hasName;
...
import org.eximeebpms.bpm.engine.rest.helper.MockTaskBuilder;
...
public class FilterRestServiceInteractionTest extends AbstractRestServiceTest {
  ...
  public void testExecuteSingleResultWithExtendingOrQuery() {
    ...
    assertEquals(2, argument.getValue().getQueries().size());
    assertEquals(MockProvider.EXAMPLE_TASK_DESCRIPTION, argument.getValue().getQueries().get(1).getDescription());
    assertEquals(MockProvider.EXAMPLE_TASK_NAME, argument.getValue().getQueries().get(1).getName());
  }
