...
public class FullHistoryTest {
  ...
  @Test
  @Deployment(resources="org/eximeebpms/bpm/engine/test/standalone/history/FullHistoryTest.testVariableUpdates.bpmn20.xml")
 ...
 // Variable status when process is finished
  ...
  @Test
  @Deployment(
    resources={"org/eximeebpms/bpm/engine/test/history/oneTaskProcess.bpmn20.xml"})
  ...
  @Test
  @Deployment(resources = "org/eximeebpms/bpm/engine/test/standalone/history/FullHistoryTest.testHistoricTaskInstanceQueryVariableInParallelBranch.bpmn20.xml")
  ...
  @Test
  @Deployment(resources={"org/eximeebpms/bpm/engine/test/standalone/history/FullHistoryTest.testHistoricProcessInstanceVariableValueEquals.bpmn20.xml"})
