 ...
 */
package org.eximeebpms.bpm.engine.impl.cfg.auth;

import static org.eximeebpms.bpm.engine.authorization.Authorization.ANY;
import static org.eximeebpms.bpm.engine.authorization.Permissions.CREATE;
import static org.eximeebpms.bpm.engine.authorization.Permissions.CREATE_INSTANCE;
import static org.eximeebpms.bpm.engine.authorization.Permissions.DELETE;
import static org.eximeebpms.bpm.engine.authorization.Permissions.DELETE_HISTORY;
import static org.eximeebpms.bpm.engine.authorization.Permissions.DELETE_INSTANCE;
import static org.eximeebpms.bpm.engine.authorization.Permissions.READ;
import static org.eximeebpms.bpm.engine.authorization.Permissions.READ_HISTORY;
import static org.eximeebpms.bpm.engine.authorization.Permissions.READ_INSTANCE;
import static org.eximeebpms.bpm.engine.authorization.Permissions.READ_TASK;
import static org.eximeebpms.bpm.engine.authorization.Permissions.TASK_ASSIGN;
import static org.eximeebpms.bpm.engine.authorization.Permissions.TASK_WORK;
import static org.eximeebpms.bpm.engine.authorization.Permissions.UPDATE;
import static org.eximeebpms.bpm.engine.authorization.Permissions.UPDATE_INSTANCE;
import static org.eximeebpms.bpm.engine.authorization.Permissions.UPDATE_TASK;
import static org.eximeebpms.bpm.engine.authorization.Resources.BATCH;
import static org.eximeebpms.bpm.engine.authorization.Resources.DECISION_DEFINITION;
import static org.eximeebpms.bpm.engine.authorization.Resources.DECISION_REQUIREMENTS_DEFINITION;
import static org.eximeebpms.bpm.engine.authorization.Resources.DEPLOYMENT;
