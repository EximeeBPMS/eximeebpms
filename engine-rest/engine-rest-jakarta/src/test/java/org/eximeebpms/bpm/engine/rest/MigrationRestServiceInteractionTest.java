...
import static org.eximeebpms.bpm.engine.rest.helper.MockProvider.ANOTHER_EXAMPLE_ACTIVITY_ID;
import static org.eximeebpms.bpm.engine.rest.helper.MockProvider.ANOTHER_EXAMPLE_PROCESS_DEFINITION_ID;
import static org.eximeebpms.bpm.engine.rest.helper.MockProvider.ANOTHER_EXAMPLE_PROCESS_INSTANCE_ID;
import static org.eximeebpms.bpm.engine.rest.helper.MockProvider.EXAMPLE_BATCH_ID;
import static org.eximeebpms.bpm.engine.rest.helper.MockProvider.EXAMPLE_BATCH_JOBS_PER_SEED;
import static org.eximeebpms.bpm.engine.rest.helper.MockProvider.EXAMPLE_BATCH_JOB_DEFINITION_ID;
import static org.eximeebpms.bpm.engine.rest.helper.MockProvider.EXAMPLE_BATCH_TOTAL_JOBS;
import static org.eximeebpms.bpm.engine.rest.helper.MockProvider.EXAMPLE_BATCH_TYPE;
import static org.eximeebpms.bpm.engine.rest.helper.MockProvider.EXAMPLE_INVOCATIONS_PER_BATCH_JOB;
import static org.eximeebpms.bpm.engine.rest.helper.MockProvider.EXAMPLE_MONITOR_JOB_DEFINITION_ID;
import static org.eximeebpms.bpm.engine.rest.helper.MockProvider.EXAMPLE_SEED_JOB_DEFINITION_ID;
import static org.eximeebpms.bpm.engine.rest.helper.MockProvider.EXAMPLE_TENANT_ID;
import static org.eximeebpms.bpm.engine.rest.helper.MockProvider.NON_EXISTING_ACTIVITY_ID;
import static org.eximeebpms.bpm.engine.rest.helper.MockProvider.NON_EXISTING_PROCESS_DEFINITION_ID;
import static org.eximeebpms.bpm.engine.rest.helper.MockProvider.createMockBatch;
import static org.eximeebpms.bpm.engine.rest.helper.NoIntermediaryInvocation.immediatelyAfter;
import static org.assertj.core.api.Assertions.assertThat;
import static org.eximeebpms.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.*;
...
import org.eximeebpms.bpm.engine.migration.MigrationInstructionValidationReport;
...
import org.eximeebpms.bpm.engine.migration.MigrationPlanValidationReport;
import org.eximeebpms.bpm.engine.migration.MigrationVariableValidationReport;
import org.eximeebpms.bpm.engine.rest.dto.VariableValueDto;
import org.eximeebpms.bpm.engine.rest.dto.migration.MigrationInstructionDto;
...
import org.eximeebpms.bpm.engine.rest.helper.MockMigrationPlanBuilder;
import org.eximeebpms.bpm.engine.rest.helper.MockMigrationPlanBuilder.JoinedMigrationPlanBuilderMock;
import org.eximeebpms.bpm.engine.rest.util.container.TestContainerRule;
import org.eximeebpms.bpm.engine.rest.util.migration.MigrationExecutionDtoBuilder;
import org.eximeebpms.bpm.engine.rest.util.migration.MigrationPlanDtoBuilder;
...
import org.eximeebpms.bpm.engine.rest.util.migration.MigrationInstructionDtoBuilder;
