...
public class EximeeBPMSBpmConfiguration {
  ...
  public static EximeeBPMSProcessEngineConfiguration camundaProcessEngineConfiguration() {
    return new DefaultProcessEngineConfiguration();
  }

  @Bean
  @ConditionalOnMissingBean(EximeeBPMSDatasourceConfiguration.class)
  public static EximeeBPMSDatasourceConfiguration camundaDatasourceConfiguration() {
  ...
  public static EximeeBPMSJobConfiguration camundaJobConfiguration() {
    return new DefaultJobConfiguration();
  }

  @Bean
  @ConditionalOnMissingBean(EximeeBPMSHistoryConfiguration.class)
  public static EximeeBPMSHistoryConfiguration camundaHistoryConfiguration() {
    return new DefaultHistoryConfiguration();
  }

  @Bean
  @ConditionalOnMissingBean(EximeeBPMSMetricsConfiguration.class)
  public static EximeeBPMSMetricsConfiguration camundaMetricsConfiguration() {
  ...
  public static EximeeBPMSAuthorizationConfiguration camundaAuthorizationConfiguration() {
    return new DefaultAuthorizationConfiguration();
  }

  @Bean
  @ConditionalOnMissingBean(EximeeBPMSDeploymentConfiguration.class)
  public static EximeeBPMSDeploymentConfiguration camundaDeploymentConfiguration() {
  ...
  @Bean
  public EximeeBPMSIntegrationDeterminator camundaIntegrationDeterminator() {
