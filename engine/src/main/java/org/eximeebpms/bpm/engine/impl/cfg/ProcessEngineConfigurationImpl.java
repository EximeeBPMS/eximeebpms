...
import static org.eximeebpms.bpm.engine.impl.cmd.HistoryCleanupCmd.MAX_THREADS_NUMBER;
...
import org.eximeebpms.bpm.engine.impl.FilterServiceImpl;
import org.eximeebpms.bpm.engine.impl.FormServiceImpl;
import org.eximeebpms.bpm.engine.impl.HistoryServiceImpl;
import org.eximeebpms.bpm.engine.impl.IdentityServiceImpl;
import org.eximeebpms.bpm.engine.impl.ManagementServiceImpl;
import org.eximeebpms.bpm.engine.impl.ModificationBatchJobHandler;
import org.eximeebpms.bpm.engine.impl.OptimizeService;
import org.eximeebpms.bpm.engine.impl.PriorityProvider;
...
import org.eximeebpms.bpm.engine.impl.RestartProcessInstancesJobHandler;
...
import org.eximeebpms.bpm.engine.impl.batch.BatchMonitorJobHandler;
import org.eximeebpms.bpm.engine.impl.batch.BatchSeedJobHandler;
import org.eximeebpms.bpm.engine.impl.batch.deletion.DeleteHistoricProcessInstancesJobHandler;
import org.eximeebpms.bpm.engine.impl.batch.deletion.DeleteProcessInstancesJobHandler;
import org.eximeebpms.bpm.engine.impl.batch.externaltask.SetExternalTaskRetriesJobHandler;
import org.eximeebpms.bpm.engine.impl.batch.job.SetJobRetriesJobHandler;
import org.eximeebpms.bpm.engine.impl.batch.message.MessageCorrelationBatchJobHandler;
import org.eximeebpms.bpm.engine.impl.batch.removaltime.BatchSetRemovalTimeJobHandler;
import org.eximeebpms.bpm.engine.impl.batch.removaltime.DecisionSetRemovalTimeJobHandler;
import org.eximeebpms.bpm.engine.impl.batch.removaltime.ProcessSetRemovalTimeJobHandler;
import org.eximeebpms.bpm.engine.impl.batch.update.UpdateProcessInstancesSuspendStateJobHandler;
import org.eximeebpms.bpm.engine.impl.batch.variables.BatchSetVariablesHandler;
...
import org.eximeebpms.bpm.engine.impl.calendar.MapBusinessCalendarManager;
import org.eximeebpms.bpm.engine.impl.cfg.auth.AuthorizationCommandChecker;
import org.eximeebpms.bpm.engine.impl.cfg.auth.DefaultAuthorizationProvider;
...
import org.eximeebpms.bpm.engine.impl.cfg.multitenancy.TenantCommandChecker;
...
import org.eximeebpms.bpm.engine.impl.db.sql.DbSqlPersistenceProviderFactory;
import org.eximeebpms.bpm.engine.impl.db.sql.DbSqlSessionFactory;
import org.eximeebpms.bpm.engine.impl.delegate.DefaultDelegateInterceptor;
import org.eximeebpms.bpm.engine.impl.diagnostics.DiagnosticsCollector;
import org.eximeebpms.bpm.engine.impl.diagnostics.DiagnosticsRegistry;
import org.eximeebpms.bpm.engine.impl.digest.Default16ByteSaltGenerator;
import org.eximeebpms.bpm.engine.impl.digest.PasswordEncryptor;
import org.eximeebpms.bpm.engine.impl.digest.PasswordManager;
import org.eximeebpms.bpm.engine.impl.digest.SaltGenerator;
import org.eximeebpms.bpm.engine.impl.digest.Sha512HashDigest;
import org.eximeebpms.bpm.engine.impl.dmn.batch.DeleteHistoricDecisionInstancesJobHandler;
import org.eximeebpms.bpm.engine.impl.dmn.configuration.DmnEngineConfigurationBuilder;
import org.eximeebpms.bpm.engine.impl.dmn.deployer.DecisionDefinitionDeployer;
import org.eximeebpms.bpm.engine.impl.dmn.deployer.DecisionRequirementsDefinitionDeployer;
...
import org.eximeebpms.bpm.engine.impl.el.CommandContextFunctions;
import org.eximeebpms.bpm.engine.impl.el.DateTimeFunctions;
import org.eximeebpms.bpm.engine.impl.el.ElProviderCompatible;
import org.eximeebpms.bpm.engine.impl.el.ExpressionManager;
import org.eximeebpms.bpm.engine.impl.el.JuelExpressionManager;
import org.eximeebpms.bpm.engine.impl.errorcode.ExceptionCodeProvider;
import org.eximeebpms.bpm.engine.impl.event.CompensationEventHandler;
import org.eximeebpms.bpm.engine.impl.event.ConditionalEventHandler;
import org.eximeebpms.bpm.engine.impl.event.EventHandler;
import org.eximeebpms.bpm.engine.impl.event.EventHandlerImpl;
...
import org.eximeebpms.bpm.engine.impl.form.type.LongFormType;
import org.eximeebpms.bpm.engine.impl.form.type.StringFormType;
import org.eximeebpms.bpm.engine.impl.form.validator.FormFieldValidator;
import org.eximeebpms.bpm.engine.impl.form.validator.FormValidators;
import org.eximeebpms.bpm.engine.impl.form.validator.MaxLengthValidator;
import org.eximeebpms.bpm.engine.impl.form.validator.MaxValidator;
import org.eximeebpms.bpm.engine.impl.form.validator.MinLengthValidator;
import org.eximeebpms.bpm.engine.impl.form.validator.MinValidator;
import org.eximeebpms.bpm.engine.impl.form.validator.ReadOnlyValidator;
import org.eximeebpms.bpm.engine.impl.form.validator.RequiredValidator;
...
import org.eximeebpms.bpm.engine.impl.identity.db.DbIdentityServiceProvider;
import org.eximeebpms.bpm.engine.impl.incident.CompositeIncidentHandler;
import org.eximeebpms.bpm.engine.impl.incident.DefaultIncidentHandler;
import org.eximeebpms.bpm.engine.impl.incident.IncidentHandler;
import org.eximeebpms.bpm.engine.impl.interceptor.CommandContextFactory;
import org.eximeebpms.bpm.engine.impl.interceptor.CommandExecutor;
import org.eximeebpms.bpm.engine.impl.interceptor.CommandExecutorImpl;
import org.eximeebpms.bpm.engine.impl.interceptor.CommandInterceptor;
import org.eximeebpms.bpm.engine.impl.interceptor.DelegateInterceptor;
import org.eximeebpms.bpm.engine.impl.interceptor.ExceptionCodeInterceptor;
...
import org.eximeebpms.bpm.engine.impl.jobexecutor.FailedJobCommandFactory;
...
import org.eximeebpms.bpm.engine.impl.jobexecutor.ProcessEventJobHandler;
import org.eximeebpms.bpm.engine.impl.jobexecutor.RejectedJobsHandler;
import org.eximeebpms.bpm.engine.impl.jobexecutor.TimerActivateJobDefinitionHandler;
import org.eximeebpms.bpm.engine.impl.jobexecutor.TimerActivateProcessDefinitionHandler;
...
import org.eximeebpms.bpm.engine.impl.jobexecutor.TimerStartEventJobHandler;
import org.eximeebpms.bpm.engine.impl.jobexecutor.TimerStartEventSubprocessJobHandler;
import org.eximeebpms.bpm.engine.impl.jobexecutor.TimerSuspendJobDefinitionHandler;
import org.eximeebpms.bpm.engine.impl.jobexecutor.TimerSuspendProcessDefinitionHandler;
import org.eximeebpms.bpm.engine.impl.jobexecutor.TimerTaskListenerJobHandler;
...
import org.eximeebpms.bpm.engine.impl.jobexecutor.historycleanup.HistoryCleanupBatch;
...
import org.eximeebpms.bpm.engine.impl.migration.MigrationActivityMatcher;
import org.eximeebpms.bpm.engine.impl.migration.MigrationInstructionGenerator;
import org.eximeebpms.bpm.engine.impl.migration.batch.MigrationBatchJobHandler;
import org.eximeebpms.bpm.engine.impl.migration.validation.activity.MigrationActivityValidator;
import org.eximeebpms.bpm.engine.impl.migration.validation.activity.NoCompensationHandlerActivityValidator;
import org.eximeebpms.bpm.engine.impl.migration.validation.activity.SupportedActivityValidator;
import org.eximeebpms.bpm.engine.impl.migration.validation.activity.SupportedPassiveEventTriggerActivityValidator;
import org.eximeebpms.bpm.engine.impl.migration.validation.instance.AsyncAfterMigrationValidator;
import org.eximeebpms.bpm.engine.impl.migration.validation.instance.AsyncMigrationValidator;
import org.eximeebpms.bpm.engine.impl.migration.validation.instance.AsyncProcessStartMigrationValidator;
import org.eximeebpms.bpm.engine.impl.migration.validation.instance.MigratingActivityInstanceValidator;
import org.eximeebpms.bpm.engine.impl.migration.validation.instance.MigratingCompensationInstanceValidator;
import org.eximeebpms.bpm.engine.impl.migration.validation.instance.MigratingTransitionInstanceValidator;
import org.eximeebpms.bpm.engine.impl.migration.validation.instance.NoUnmappedCompensationStartEventValidator;
import org.eximeebpms.bpm.engine.impl.migration.validation.instance.NoUnmappedLeafInstanceValidator;
import org.eximeebpms.bpm.engine.impl.migration.validation.instance.SupportedActivityInstanceValidator;
import org.eximeebpms.bpm.engine.impl.migration.validation.instance.VariableConflictActivityInstanceValidator;
import org.eximeebpms.bpm.engine.impl.migration.validation.instruction.AdditionalFlowScopeInstructionValidator;
import org.eximeebpms.bpm.engine.impl.migration.validation.instruction.CannotAddMultiInstanceBodyValidator;
import org.eximeebpms.bpm.engine.impl.migration.validation.instruction.CannotAddMultiInstanceInnerActivityValidator;
import org.eximeebpms.bpm.engine.impl.migration.validation.instruction.CannotRemoveMultiInstanceInnerActivityValidator;
import org.eximeebpms.bpm.engine.impl.migration.validation.instruction.ConditionalEventUpdateEventTriggerValidator;
import org.eximeebpms.bpm.engine.impl.migration.validation.instruction.GatewayMappingValidator;
import org.eximeebpms.bpm.engine.impl.migration.validation.instruction.MigrationInstructionValidator;
import org.eximeebpms.bpm.engine.impl.migration.validation.instruction.OnlyOnceMappedActivityInstructionValidator;
import org.eximeebpms.bpm.engine.impl.migration.validation.instruction.SameBehaviorInstructionValidator;
import org.eximeebpms.bpm.engine.impl.migration.validation.instruction.SameEventScopeInstructionValidator;
import org.eximeebpms.bpm.engine.impl.migration.validation.instruction.SameEventTypeValidator;
import org.eximeebpms.bpm.engine.impl.migration.validation.instruction.UpdateEventTriggersValidator;
import org.eximeebpms.bpm.engine.impl.optimize.OptimizeManager;
import org.eximeebpms.bpm.engine.impl.persistence.GenericManagerFactory;
...
import org.eximeebpms.bpm.engine.impl.persistence.deploy.cache.DefaultCacheFactory;
...
import org.eximeebpms.bpm.engine.impl.persistence.entity.ExternalTaskManager;
...
import org.eximeebpms.bpm.engine.impl.persistence.entity.HistoricIncidentManager;
import org.eximeebpms.bpm.engine.impl.persistence.entity.HistoricJobLogManager;
import org.eximeebpms.bpm.engine.impl.persistence.entity.HistoricProcessInstanceManager;
import org.eximeebpms.bpm.engine.impl.persistence.entity.HistoricStatisticsManager;
import org.eximeebpms.bpm.engine.impl.persistence.entity.HistoricTaskInstanceManager;
import org.eximeebpms.bpm.engine.impl.persistence.entity.HistoricVariableInstanceManager;
import org.eximeebpms.bpm.engine.impl.persistence.entity.IdentityInfoManager;
import org.eximeebpms.bpm.engine.impl.persistence.entity.IdentityLinkManager;
import org.eximeebpms.bpm.engine.impl.persistence.entity.IncidentManager;
import org.eximeebpms.bpm.engine.impl.persistence.entity.JobDefinitionManager;
import org.eximeebpms.bpm.engine.impl.persistence.entity.JobManager;
import org.eximeebpms.bpm.engine.impl.persistence.entity.MeterLogManager;
...
import org.eximeebpms.bpm.engine.impl.persistence.entity.TaskReportManager;
import org.eximeebpms.bpm.engine.impl.persistence.entity.TenantManager;
import org.eximeebpms.bpm.engine.impl.persistence.entity.UserOperationLogManager;
import org.eximeebpms.bpm.engine.impl.persistence.entity.VariableInstanceManager;
import org.eximeebpms.bpm.engine.impl.repository.DefaultDeploymentHandlerFactory;
import org.eximeebpms.bpm.engine.impl.runtime.ConditionHandler;
import org.eximeebpms.bpm.engine.impl.runtime.CorrelationHandler;
import org.eximeebpms.bpm.engine.impl.runtime.DefaultConditionHandler;
import org.eximeebpms.bpm.engine.impl.runtime.DefaultCorrelationHandler;
...
import org.eximeebpms.bpm.engine.impl.telemetry.dto.ProductImpl;
...
import org.eximeebpms.bpm.engine.impl.util.ProcessEngineDetails;
import org.eximeebpms.bpm.engine.impl.util.ReflectUtil;
import org.eximeebpms.bpm.engine.impl.variable.ValueTypeResolverImpl;
import org.eximeebpms.bpm.engine.impl.variable.serializer.BooleanValueSerializer;
import org.eximeebpms.bpm.engine.impl.variable.serializer.ByteArrayValueSerializer;
import org.eximeebpms.bpm.engine.impl.variable.serializer.DateValueSerializer;
import org.eximeebpms.bpm.engine.impl.variable.serializer.DefaultVariableSerializers;
import org.eximeebpms.bpm.engine.impl.variable.serializer.DoubleValueSerializer;
import org.eximeebpms.bpm.engine.impl.variable.serializer.FileValueSerializer;
import org.eximeebpms.bpm.engine.impl.variable.serializer.IntegerValueSerializer;
import org.eximeebpms.bpm.engine.impl.variable.serializer.JavaObjectSerializer;
import org.eximeebpms.bpm.engine.impl.variable.serializer.LongValueSerlializer;
import org.eximeebpms.bpm.engine.impl.variable.serializer.NullValueSerializer;
import org.eximeebpms.bpm.engine.impl.variable.serializer.ShortValueSerializer;
import org.eximeebpms.bpm.engine.impl.variable.serializer.StringValueSerializer;
...
public abstract class ProcessEngineConfigurationImpl extends ProcessEngineConfiguration {
  ...
  public static final String DEFAULT_WS_SYNC_FACTORY = "org.eximeebpms.bpm.engine.impl.webservice.CxfWebServiceClientFactory";

  public static final String DEFAULT_MYBATIS_MAPPING_FILE = "org/eximeebpms/bpm/engine/impl/mapping/mappings.xml";
  ...
  /**
   * As an instance of {@link org.eximeebpms.bpm.engine.impl.history.handler.CompositeHistoryEventHandler}
    ...
    synchronized (ProcessEngineConfigurationImpl.class) {
      ...
      if (sqlSessionFactory == null) {
        ...
        try {
          ...
          if (isUseSharedSqlSessionFactory) {
            properties.put("prefix", "${@org.eximeebpms.bpm.engine.impl.context.Context@getProcessEngineConfiguration().databaseTablePrefix}");
          } else {
