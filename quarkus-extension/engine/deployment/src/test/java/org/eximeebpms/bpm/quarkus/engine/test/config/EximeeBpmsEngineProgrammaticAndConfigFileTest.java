 ...
 */
package org.eximeebpms.bpm.quarkus.engine.test.config;
...
class EximeeBpmsEngineProgrammaticAndConfigFileTest {

  @RegisterExtension
  static final QuarkusUnitTest unitTest = new ProcessEngineAwareExtension()
      .withConfigurationResource("org/eximeebpms/bpm/quarkus/engine/test/config/mixed-application.properties")
