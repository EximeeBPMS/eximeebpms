...
public class EximeeBPMSSpringSecurityOAuth2AutoConfigurationTest {
  ...
  public void sanitizePath_null_returnsEmpty() {
    assertThat(EximeeBPMSSpringSecurityOAuth2AutoConfiguration.sanitizePath(null)).isEmpty();
  }

  @Test
  public void sanitizePath_empty_returnsEmpty() {
    assertThat(EximeeBPMSSpringSecurityOAuth2AutoConfiguration.sanitizePath("")).isEmpty();
  }
