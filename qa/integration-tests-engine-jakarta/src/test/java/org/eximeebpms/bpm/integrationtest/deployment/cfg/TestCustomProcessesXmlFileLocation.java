...
public class TestCustomProcessesXmlFileLocation extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    ...
    WebArchive archive = ShrinkWrap.create(WebArchive.class, "test.war")
        ...
        .addAsResource("org/eximeebpms/bpm/integrationtest/deployment/cfg/processes.xml", "my/alternate/location/processes.xml")
        .addClass(AbstractFoxPlatformIntegrationTest.class)
        .addClass(CustomProcessApplication.class)
        .addAsResource("org/eximeebpms/bpm/integrationtest/deployment/cfg/invoice-it.bpmn20.xml");
