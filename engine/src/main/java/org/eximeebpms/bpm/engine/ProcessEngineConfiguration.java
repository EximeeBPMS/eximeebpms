...
import org.eximeebpms.bpm.engine.impl.cfg.BeansConfigurationHelper;
...
public abstract class ProcessEngineConfiguration {
  ...
  protected String mailServerDefaultFrom = "eximeebpms@localhost";
  ...
  public static ProcessEngineConfiguration createProcessEngineConfigurationFromResourceDefault() {
    ...
    try {
      processEngineConfiguration = createProcessEngineConfigurationFromResource("eximeebpms.cfg.xml", "processEngineConfiguration");
