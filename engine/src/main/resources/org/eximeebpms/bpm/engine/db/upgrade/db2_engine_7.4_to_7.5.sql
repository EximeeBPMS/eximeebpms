...
VALUES
  ('eximeebpms-admin-grant-tenant', 1, 'eximeebpms-admin', 11, '*', 2147483647, 1),
  ('eximeebpms-admin-grant-tenant-membership', 1, 'eximeebpms-admin', 12, '*', 2147483647, 1),
  ('eximeebpms-admin-grant-batch', 1, 'eximeebpms-admin', 13, '*', 2147483647, 1);
