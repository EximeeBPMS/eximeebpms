...
import org.eximeebpms.bpm.model.bpmn.instance.BpmnModelElementInstanceTest;
 ...
 */
public class EximeeBpmsOutputParameterTest extends BpmnModelElementInstanceTest {
  ...
  public void testOutputParameterScriptChildAssignment() {
    try {
      ...
      fail("EximeeBpmsScript should be accepted as a child element of EximeeBpmsOutputParameter. Error: " + e.getMessage());
    }
  }
  ...
  public void testOutputParameterListChildAssignment() {
    try {
      ...
      fail("EximeeBpmsList should be accepted as a child element of EximeeBpmsOutputParameter. Error: " + e.getMessage());
    }
  }
  ...
  public void testOutputParameterMapChildAssignment() {
    try {
      ...
      fail("EximeeBpmsMap should be accepted as a child element of EximeeBpmsOutputParameter. Error: " + e.getMessage());
    }
  }
}
