 ...
 */
package org.eximeebpms.bpm.quarkus.engine.extension.impl;
...
import org.eximeebpms.bpm.engine.cdi.impl.event.CdiEventSupportBpmnParseListener;
...
public class EximeeBpmsEngineRecorder {
  ...
  public void fireEximeeBpmsEngineStartEvent() {
    Arc.container().beanManager()
        .getEvent()
        .select(EximeeBpmsEngineStartupEvent.class)
        .fire(new EximeeBpmsEngineStartupEvent());
  }
