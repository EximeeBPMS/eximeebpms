  ...
  private DmnModelInstance modelInstance;
   ...
   public static Collection<Object[]> parameters(){
     return Arrays.asList(new Object[][]{
         {Dmn.readModelFromStream(EximeeBpmsExtensionsTest.class.getResourceAsStream("EximeeBpmsExtensionsTest.dmn"))},
         // for compatibility reasons we gotta check the old namespace, too
         {Dmn.readModelFromStream(EximeeBpmsExtensionsTest.class.getResourceAsStream("CamundaExtensionsCompatibilityTest.dmn"))}
     });
   }

  public EximeeBpmsExtensionsTest(DmnModelInstance originalModelInstance) {
