...
import org.eximeebpms.bpm.client.spring.SpringTopicSubscription;
import org.eximeebpms.bpm.client.spring.boot.starter.subscription.configuration.FullSubscriptionConfiguration;
...
@TestPropertySource(properties = {
    ...
    "eximeebpms.bpm.client.subscriptions.topic-one.process-definition-id=id-one",
})
