...
import org.eximeebpms.bpm.model.bpmn.instance.ResourceAssignmentExpression;
...
import static org.eximeebpms.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ELEMENT_POTENTIAL_STARTER;
 ...
 */
public class EximeeBpmsPotentialStarterImpl extends BpmnModelElementInstanceImpl implements EximeeBpmsPotentialStarter {

  protected static ChildElement<ResourceAssignmentExpression> resourceAssignmentExpressionChild;

  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(EximeeBpmsPotentialStarter.class, CAMUNDA_ELEMENT_POTENTIAL_STARTER)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(EximeeBpmsPotentialStarterImpl::new);
  ...
  public EximeeBpmsPotentialStarterImpl(ModelTypeInstanceContext instanceContext) {
