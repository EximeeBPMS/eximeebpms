...
public interface EximeeBpmsEngineConfig {
   ...
   */
  EximeeBpmsJobExecutorConfig jobExecutor();
   ...
   *   <li>{@code uuid-v1} — <b>Removed in 1.4.0.</b> Falls back to {@code strong} (UUID v7) with a startup warning.</li>
   * </ul>
   */
