...
public class EximeeBpmsBpmVersionTest {
  ...
  public static EximeeBpmsBpmVersion eximeeBpmsBpmVersion(final String version) {
  ...
  public void isEnterprise_true() throws Exception {
    assertThat(eximeeBpmsBpmVersion("7.6.0-alpha3-ee").isEnterprise()).isTrue();
  }

  @Test
  public void isEnterprise_false() throws Exception {
    assertThat(eximeeBpmsBpmVersion("7.6.0-alpha3").isEnterprise()).isFalse();
  }
}
