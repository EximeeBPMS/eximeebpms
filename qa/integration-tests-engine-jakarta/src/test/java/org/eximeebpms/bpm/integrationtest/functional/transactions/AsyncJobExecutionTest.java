 ...
 */
package org.eximeebpms.bpm.integrationtest.functional.transactions;
...
import org.eximeebpms.bpm.integrationtest.functional.transactions.beans.FailingTransactionListenerDelegate;
import org.eximeebpms.bpm.integrationtest.functional.transactions.beans.GetVersionInfoDelegate;
import org.eximeebpms.bpm.integrationtest.functional.transactions.beans.UpdateRouterConfiguration;
...
public class AsyncJobExecutionTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    return initWebArchiveDeployment()
            ...
            .addAsResource("org/eximeebpms/bpm/integrationtest/functional/transactions/AsyncJobExecutionTest.testAsyncServiceTasks.bpmn20.xml")
            .addAsResource("org/eximeebpms/bpm/integrationtest/functional/transactions/AsyncJobExecutionTest.failingTransactionListener.bpmn20.xml")
