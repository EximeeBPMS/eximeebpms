...
import static org.eximeebpms.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ELEMENT_VALIDATION;
 ...
 */
public class EximeeBpmsValidationImpl extends BpmnModelElementInstanceImpl implements EximeeBpmsValidation {

  protected static ChildElementCollection<EximeeBpmsConstraint> camundaConstraintCollection;

  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(EximeeBpmsValidation.class, CAMUNDA_ELEMENT_VALIDATION)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(EximeeBpmsValidationImpl::new);

    SequenceBuilder sequenceBuilder = typeBuilder.sequence();

    camundaConstraintCollection = sequenceBuilder.elementCollection(EximeeBpmsConstraint.class)
      .build();

    typeBuilder.build();
  }

  public EximeeBpmsValidationImpl(ModelTypeInstanceContext instanceContext) {
    super(instanceContext);
  }

  public Collection<EximeeBpmsConstraint> getEximeeBpmsConstraints() {
