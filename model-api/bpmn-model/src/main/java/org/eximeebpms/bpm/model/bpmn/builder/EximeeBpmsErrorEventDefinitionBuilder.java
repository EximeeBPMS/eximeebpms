...
public class EximeeBpmsErrorEventDefinitionBuilder extends AbstractErrorEventDefinitionBuilder<EximeeBpmsErrorEventDefinitionBuilder> {

  public EximeeBpmsErrorEventDefinitionBuilder(BpmnModelInstance modelInstance, ErrorEventDefinition element) {
    super(modelInstance, element, EximeeBpmsErrorEventDefinitionBuilder.class);
  }

  public EximeeBpmsErrorEventDefinitionBuilder expression(String expression) {
