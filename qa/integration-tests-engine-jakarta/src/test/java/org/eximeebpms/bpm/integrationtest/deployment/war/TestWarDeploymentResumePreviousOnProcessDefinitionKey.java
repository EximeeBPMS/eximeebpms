...
public class TestWarDeploymentResumePreviousOnProcessDefinitionKey  extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive1() {
    return initWebArchiveDeployment("pa1.war")
      .addAsResource("org/eximeebpms/bpm/integrationtest/deployment/war/testDeployProcessArchiveV1.bpmn20.xml");
  }

  @Deployment(order=2, name=PA2)
  public static WebArchive processArchive2() {
    return initWebArchiveDeployment("pa2.war", "org/eximeebpms/bpm/integrationtest/deployment/war/resumePreviousVersionsOnProcessDefinitionKey_processes.xml")
      .addAsResource("org/eximeebpms/bpm/integrationtest/deployment/war/testDeployProcessArchiveV2.bpmn20.xml");
