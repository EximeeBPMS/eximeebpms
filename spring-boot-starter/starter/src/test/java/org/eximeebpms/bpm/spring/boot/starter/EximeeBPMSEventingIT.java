...
import org.eximeebpms.bpm.spring.boot.starter.event.TaskEvent;
import org.eximeebpms.bpm.spring.boot.starter.test.nonpa.BoundaryEventServiceTask;
import org.eximeebpms.bpm.spring.boot.starter.test.nonpa.TestApplication;
import org.eximeebpms.bpm.spring.boot.starter.test.nonpa.TestEventCaptor;
...
public class EximeeBPMSEventingIT extends AbstractEximeeBPMSAutoConfigurationIT {
  ...
  public final void shouldNotInvokeHandlerOnModificationWhenSkippingCustomListeners() {
    ...
    // then
    assertThat(eventCaptor.executionEvents).isEmpty();
//    assertThat(eventCaptor.taskEvents).isEmpty(); => https://github.com/eximeebpms/eximeebpms-bpm-platform/issues/3103
  }
