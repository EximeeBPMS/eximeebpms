 ...
 */
package org.eximeebpms.bpm.engine.impl.db;
...
import org.eximeebpms.bpm.engine.WrongDbException;
...
import org.eximeebpms.bpm.engine.impl.util.ClassNameUtil;
...
public class EnginePersistenceLogger extends ProcessEngineLogger {
  ...
  protected static final String HINT_TEXT = "Hint: Set <property name=\"databaseSchemaUpdate\" to value=\"true\" or " +
                                            ...
                                            "processEngineConfiguration in eximeebpms.cfg.xml for automatic schema creation";
