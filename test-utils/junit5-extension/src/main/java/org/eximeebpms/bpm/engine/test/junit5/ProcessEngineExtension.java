 ...
 */
package org.eximeebpms.bpm.engine.test.junit5;
 ...
 * <p>
 * If you provide a {@code eximeebpms.cfg.xml} file on the classpath. This file is used to configure the process engine.
 * <br>
 * Usage:
 * </p>
 * <pre>
 ...
 *
 * <p>
 * If you want to choose the {@code eximeebpms.cfg.xml} file that is used in the test programmatically,
...
public class ProcessEngineExtension implements TestWatcher,
  ...
  public ProcessEngineExtension manageDeployment(org.eximeebpms.bpm.engine.repository.Deployment deployment) {
