= EximeeBPMS BPMN model API

The EximeeBPMS BPMN model API is a simple, lightweight Java library for parsing, creating and editing BPMN 2.0 XML files. It is licensed under the Apache 2.0 license.

[NOTE]
====
EximeeBPMS BPMN model can be used standalone, independenly of EximeeBPMS Platform / process engine.
====

* Web Site: https://eximeebpms.org/
* User Guide: link:https://docs.eximeebpms.org/latest/guides/user-guide/#bpmn-model-api[https://docs.eximeebpms.org]
...
and can be executed by the EximeeBPMS.
...
For more complex examples see the link:https://docs.eximeebpms.org/manual/latest/user-guide/model-api/bpmn-model-api/fluent-builder-api/[docs],
