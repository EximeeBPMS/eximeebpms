...
public class EximeeBpmsFormDefinitionCache extends ResourceDefinitionCache<EximeeBpmsFormDefinitionEntity> {

  public EximeeBpmsFormDefinitionCache(CacheFactory factory, int cacheCapacity, CacheDeployer cacheDeployer) {
    super(factory, cacheCapacity, cacheDeployer);
  }

  @Override
  protected AbstractResourceDefinitionManager<EximeeBpmsFormDefinitionEntity> getManager() {
    return Context.getCommandContext().getEximeeBpmsFormDefinitionManager();
  }
  ...
  @Override
  protected void checkDefinitionFound(String definitionId, EximeeBpmsFormDefinitionEntity definition) {
    ensureNotNull("no deployed camunda form definition found with id '" + definitionId + "'", "camundaFormDefinition", definition);
  }

  @Override
  protected void checkInvalidDefinitionByKey(String definitionKey, EximeeBpmsFormDefinitionEntity definition) {
    ensureNotNull("no deployed camunda form definition found with key '" + definitionKey + "'", "camundaFormDefinition", definition);
  }

  @Override
  protected void checkInvalidDefinitionByKeyAndTenantId(String definitionKey, String tenantId, EximeeBpmsFormDefinitionEntity definition) {
  ...
  @Override
  protected void checkInvalidDefinitionByKeyVersionAndTenantId(String definitionKey, Integer definitionVersion, String tenantId, EximeeBpmsFormDefinitionEntity definition) {
  ...
  protected void checkInvalidDefinitionByKeyVersionTagAndTenantId(String definitionKey, String definitionVersionTag, String tenantId,
      EximeeBpmsFormDefinitionEntity definition) {
    // version tag is currently not supported for EximeeBpmsFormDefinition
  }

  @Override
  protected void checkInvalidDefinitionByDeploymentAndKey(String deploymentId, String definitionKey, EximeeBpmsFormDefinitionEntity definition) {
  ...
  @Override
  protected void checkInvalidDefinitionWasCached(String deploymentId, String definitionId, EximeeBpmsFormDefinitionEntity definition) {
