...
public class QueryByIdAfterTest {
  ...
  @Test
  @Deployment(resources={"org/eximeebpms/bpm/engine/test/api/runtime/oneFailingServiceProcess.bpmn20.xml"})
  ...
  @Test
  @Deployment(resources = "org/eximeebpms/bpm/engine/test/history/HistoricActivityInstanceTest.testHistoricActivityInstanceNoop.bpmn20.xml")
  ...
  public void shouldProcessDefinitionApiReturnOnlyAfterGivenId() {
    // given
    deployProcessDefinitions("org/eximeebpms/bpm/engine/test/api/oneTaskProcess.bpmn20.xml", 10);
