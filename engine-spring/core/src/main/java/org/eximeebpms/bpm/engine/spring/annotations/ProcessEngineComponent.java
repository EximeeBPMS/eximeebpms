 ...
 */
package org.eximeebpms.bpm.engine.spring.annotations;
 ...
 * tasked with responding to a state. If applied to a bean and there are no {@link org.eximeebpms.bpm.engine.annotations.ProcessEngineComponent}
