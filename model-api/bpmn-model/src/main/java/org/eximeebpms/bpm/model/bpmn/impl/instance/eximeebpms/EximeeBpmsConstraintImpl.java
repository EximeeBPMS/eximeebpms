 ...
 */
public class EximeeBpmsConstraintImpl extends BpmnModelElementInstanceImpl implements EximeeBpmsConstraint {
  ...
  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(EximeeBpmsConstraint.class, CAMUNDA_ELEMENT_CONSTRAINT)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(EximeeBpmsConstraintImpl::new);
  ...
  public EximeeBpmsConstraintImpl(ModelTypeInstanceContext instanceContext) {
