...
import static org.eximeebpms.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ELEMENT_STRING;
 ...
 */
public class EximeeBpmsStringImpl extends BpmnModelElementInstanceImpl implements EximeeBpmsString {

  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(EximeeBpmsString.class, CAMUNDA_ELEMENT_STRING)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(EximeeBpmsStringImpl::new);

    typeBuilder.build();
  }

  public EximeeBpmsStringImpl(ModelTypeInstanceContext instanceContext) {
