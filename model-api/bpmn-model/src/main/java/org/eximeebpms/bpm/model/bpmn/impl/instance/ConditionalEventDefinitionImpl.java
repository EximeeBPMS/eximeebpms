...
import static org.eximeebpms.bpm.model.bpmn.impl.BpmnModelConstants.BPMN_ELEMENT_CONDITIONAL_EVENT_DEFINITION;
import static org.eximeebpms.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_VARIABLE_NAME;
...
import static org.eximeebpms.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_VARIABLE_EVENTS;
...
public class ConditionalEventDefinitionImpl extends EventDefinitionImpl implements ConditionalEventDefinition {
  ...
  @Override
  public String getEximeeBpmsVariableName() {
    return camundaVariableName.getValue(this);
  }

  @Override
  public void setEximeeBpmsVariableName(String variableName) {
    camundaVariableName.setValue(this, variableName);
  }

  @Override
  public String getEximeeBpmsVariableEvents() {
    return camundaVariableEvents.getValue(this);
  }

  @Override
  public void setEximeeBpmsVariableEvents(String variableEvents) {
    camundaVariableEvents.setValue(this, variableEvents);
  }

  @Override
  public List<String> getEximeeBpmsVariableEventsList() {
    String variableEvents = camundaVariableEvents.getValue(this);
    return StringUtil.splitCommaSeparatedList(variableEvents);
  }

  @Override
  public void setEximeeBpmsVariableEventsList(List<String> variableEventsList) {
