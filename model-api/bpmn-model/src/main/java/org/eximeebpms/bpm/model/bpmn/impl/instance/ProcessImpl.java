...
import static org.eximeebpms.bpm.model.bpmn.impl.BpmnModelConstants.BPMN_ATTRIBUTE_IS_CLOSED;
import static org.eximeebpms.bpm.model.bpmn.impl.BpmnModelConstants.BPMN_ATTRIBUTE_IS_EXECUTABLE;
import static org.eximeebpms.bpm.model.bpmn.impl.BpmnModelConstants.BPMN_ATTRIBUTE_PROCESS_TYPE;
import static org.eximeebpms.bpm.model.bpmn.impl.BpmnModelConstants.BPMN_ELEMENT_PROCESS;
import static org.eximeebpms.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_CANDIDATE_STARTER_GROUPS;
import static org.eximeebpms.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_CANDIDATE_STARTER_USERS;
import static org.eximeebpms.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_HISTORY_TIME_TO_LIVE;
import static org.eximeebpms.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_IS_STARTABLE_IN_TASKLIST;
import static org.eximeebpms.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_JOB_PRIORITY;
import static org.eximeebpms.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_TASK_PRIORITY;
import static org.eximeebpms.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_VERSION_TAG;
...
import org.eximeebpms.bpm.model.bpmn.instance.Auditing;
import org.eximeebpms.bpm.model.bpmn.instance.CallableElement;
import org.eximeebpms.bpm.model.bpmn.instance.CorrelationSubscription;
import org.eximeebpms.bpm.model.bpmn.instance.FlowElement;
import org.eximeebpms.bpm.model.bpmn.instance.LaneSet;
import org.eximeebpms.bpm.model.bpmn.instance.Monitoring;
import org.eximeebpms.bpm.model.bpmn.instance.Process;
import org.eximeebpms.bpm.model.bpmn.instance.Property;
import org.eximeebpms.bpm.model.bpmn.instance.ResourceRole;
...
import org.eximeebpms.bpm.model.xml.impl.util.StringUtil;
...
public class ProcessImpl extends CallableElementImpl implements Process {
  ...
  public String getEximeeBpmsCandidateStarterGroups() {
    return camundaCandidateStarterGroupsAttribute.getValue(this);
  }

  public void setEximeeBpmsCandidateStarterGroups(String camundaCandidateStarterGroups) {
    camundaCandidateStarterGroupsAttribute.setValue(this, camundaCandidateStarterGroups);
  }

  public List<String> getEximeeBpmsCandidateStarterGroupsList() {
  ...
  public void setEximeeBpmsCandidateStarterGroupsList(List<String> camundaCandidateStarterGroupsList) {
  ...
  public String getEximeeBpmsCandidateStarterUsers() {
    return camundaCandidateStarterUsersAttribute.getValue(this);
  }

  public void setEximeeBpmsCandidateStarterUsers(String camundaCandidateStarterUsers) {
    camundaCandidateStarterUsersAttribute.setValue(this, camundaCandidateStarterUsers);
  }

  public List<String> getEximeeBpmsCandidateStarterUsersList() {
  ...
  public void setEximeeBpmsCandidateStarterUsersList(List<String> camundaCandidateStarterUsersList) {
  ...
  @Override
  public Boolean isEximeeBpmsStartableInTasklist() {
    return camundaIsStartableInTasklistAttribute.getValue(this);
  }

  @Override
  public void setEximeeBpmsIsStartableInTasklist(Boolean isStartableInTasklist) {
    camundaIsStartableInTasklistAttribute.setValue(this, isStartableInTasklist);
  }

  @Override
  public String getEximeeBpmsVersionTag() {
    return camundaVersionTagAttribute.getValue(this);
  }

  @Override
  public void setEximeeBpmsVersionTag(String versionTag) {
