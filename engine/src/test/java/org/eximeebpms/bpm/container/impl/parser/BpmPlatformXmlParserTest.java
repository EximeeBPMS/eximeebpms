 ...
 */
package org.eximeebpms.bpm.container.impl.parser;
...
import org.eximeebpms.bpm.container.impl.metadata.spi.JobAcquisitionXml;
...
public class BpmPlatformXmlParserTest {
  ...
  public void testParseBpmPlatformXmlNoEngine() {
    ...
    assertEquals("org.eximeebpms.bpm.engine.impl.jobexecutor.DefaultJobExecutor", jobAcquisitionXml.getJobExecutorClassName());
  ...
  public void testParseBpmPlatformXmlEnginePlugin() {
    ...
    assertEquals("org.eximeebpms.bpm.MyAwesomePlugin", plugin1.getPluginClass());
