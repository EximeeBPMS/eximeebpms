 ...
 */
package org.eximeebpms.bpm.engine.history;
...
public interface UserOperationLogQuery extends Query<UserOperationLogQuery, UserOperationLogEntry> {
   ...
   * for instance, a User may update multiple fields of a UserTask when calling {@link TaskService#saveTask(org.eximeebpms.bpm.engine.task.Task)}
