 ...
 */
package org.eximeebpms.bpm.qa.rolling.update;


import org.eximeebpms.bpm.engine.ProcessEngine;
import org.eximeebpms.bpm.engine.ProcessEngineConfiguration;
import org.eximeebpms.bpm.engine.impl.cfg.ProcessEngineConfigurationImpl;
import org.eximeebpms.bpm.qa.rolling.update.scenarios.DeploymentWhichShouldBeDeletedScenario;
import org.eximeebpms.bpm.qa.rolling.update.scenarios.authorization.AuthorizationScenario;
import org.eximeebpms.bpm.qa.rolling.update.scenarios.batch.SetRemovalTimeToProcessInstanceScenario;
import org.eximeebpms.bpm.qa.rolling.update.scenarios.callactivity.ProcessWithCallActivityScenario;
import org.eximeebpms.bpm.qa.rolling.update.scenarios.cleanup.HistoryCleanupScenario;
import org.eximeebpms.bpm.qa.rolling.update.scenarios.eventSubProcess.ProcessWithEventSubProcessScenario;
import org.eximeebpms.bpm.qa.rolling.update.scenarios.externalTask.ProcessWithExternalTaskScenario;
import org.eximeebpms.bpm.qa.rolling.update.scenarios.mulltiInstance.ProcessWithMultiInstanceCallActivityScenario;
import org.eximeebpms.bpm.qa.rolling.update.scenarios.task.ProcessWithAsyncServiceTaskScenario;
import org.eximeebpms.bpm.qa.rolling.update.scenarios.task.ProcessWithParallelGatewayAndServiceTaskScenario;
import org.eximeebpms.bpm.qa.rolling.update.scenarios.task.ProcessWithParallelGatewayScenario;
import org.eximeebpms.bpm.qa.rolling.update.scenarios.task.ProcessWithUserTaskAndTimerScenario;
import org.eximeebpms.bpm.qa.rolling.update.scenarios.task.ProcessWithUserTaskScenario;
import org.eximeebpms.bpm.qa.rolling.update.scenarios.timestamp.IncidentTimestampUpdateScenario;
import org.eximeebpms.bpm.qa.rolling.update.scenarios.timestamp.JobTimestampsUpdateScenario;
import org.eximeebpms.bpm.qa.rolling.update.scenarios.variable.EmptyStringVariableScenario;
import org.eximeebpms.bpm.qa.upgrade.ScenarioRunner;
