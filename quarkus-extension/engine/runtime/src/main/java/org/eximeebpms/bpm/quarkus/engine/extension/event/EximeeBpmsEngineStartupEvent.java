 ...
 */
package org.eximeebpms.bpm.quarkus.engine.extension.event;
 ...
 *
 * <code><pre>
 *     void onCamundaEngineStart(@Observes EximeeBpmsEngineStartupEvent event) {
 *         LOGGER.info("The Camunda engine is started");
 *     }
 * </pre></code>
 */
public class EximeeBpmsEngineStartupEvent {
}