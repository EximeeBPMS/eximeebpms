...
@EnableConfigurationProperties({
  EximeeBpmsBpmProperties.class,
  ManagementProperties.class
})
@Import({
  EximeeBpmsBpmConfiguration.class,
  EximeeBpmsBpmActuatorConfiguration.class,
  EximeeBpmsBpmPluginConfiguration.class,
  EximeeBpmsBpmTelemetryConfiguration.class,
  SpringProcessEngineServicesConfiguration.class
})
@Configuration
@ConditionalOnProperty(prefix = EximeeBpmsBpmProperties.PREFIX, name = "enabled", matchIfMissing = true)
@AutoConfigureAfter(HibernateJpaAutoConfiguration.class)
public class EximeeBpmsBpmAutoConfiguration {
  ...
  @Bean
  public EximeeBpmsBpmVersion eximeeBpmsBpmVersion() {
    return new EximeeBpmsBpmVersion();
  }
