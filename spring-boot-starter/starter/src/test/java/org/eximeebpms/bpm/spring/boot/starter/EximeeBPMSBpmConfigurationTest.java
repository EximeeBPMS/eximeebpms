...
public class EximeeBPMSBpmConfigurationTest {

  @Test
  public void processEngineConfigurationImplTest() {
    EximeeBPMSBpmConfiguration eximeeBPMSBpmConfiguration = new EximeeBPMSBpmConfiguration();
    List<ProcessEnginePlugin> processEnginePlugins = createUnordedList();
    ProcessEngineConfigurationImpl processEngineConfigurationImpl = eximeeBPMSBpmConfiguration.processEngineConfigurationImpl(processEnginePlugins);
