...
public interface EximeeBpmsJobExecutorConfig {

  /**
   * The Camunda JobExecutor configuration properties. For more details,
   * @see <a href="https://docs.eximeebpms.org/manual/latest/reference/deployment-descriptors/tags/job-executor/#job-acquisition-configuration-properties">Job-Acquisition Configuration Properties</a>
   */
