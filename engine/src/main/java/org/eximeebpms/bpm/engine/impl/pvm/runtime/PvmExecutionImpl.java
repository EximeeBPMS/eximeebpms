 ...
 */
package org.eximeebpms.bpm.engine.impl.pvm.runtime;

import static org.eximeebpms.bpm.engine.impl.bpmn.helper.CompensationUtil.SIGNAL_COMPENSATION_DONE;
import static org.eximeebpms.bpm.engine.impl.pvm.runtime.ActivityInstanceState.ENDING;
...
import org.eximeebpms.bpm.engine.ActivityTypes;
...
import org.eximeebpms.bpm.engine.impl.form.FormPropertyHelper;
...
import org.eximeebpms.bpm.engine.impl.history.event.HistoryEventProcessor;
...
import org.eximeebpms.bpm.engine.impl.incident.IncidentHandling;
import org.eximeebpms.bpm.engine.impl.persistence.entity.DelayedVariableEvent;
...
import org.eximeebpms.bpm.engine.impl.pvm.delegate.SignallableActivityBehavior;
...
import org.eximeebpms.bpm.engine.impl.tree.ExecutionWalker;
import org.eximeebpms.bpm.engine.impl.tree.FlowScopeWalker;
import org.eximeebpms.bpm.engine.impl.tree.LeafActivityInstanceExecutionCollector;
import org.eximeebpms.bpm.engine.impl.tree.ReferenceWalker;
import org.eximeebpms.bpm.engine.impl.tree.ScopeCollector;
import org.eximeebpms.bpm.engine.impl.tree.ScopeExecutionCollector;
import org.eximeebpms.bpm.engine.impl.tree.TreeVisitor;
...
public abstract class PvmExecutionImpl extends CoreExecution implements
   ...
   * check  https://github.com/eximeebpms/eximeebpms-bpm-platform/issues/3979
   */
