 ...
 */
package org.eximeebpms.bpm.spring.boot.starter.webapp.apppath;

import org.eximeebpms.bpm.spring.boot.starter.webapp.WebappTestApp;
...
import static org.eximeebpms.bpm.webapp.impl.security.filter.headersec.provider.impl.ContentSecurityPolicyProvider.HEADER_DEFAULT_VALUE;
import static org.eximeebpms.bpm.webapp.impl.security.filter.headersec.provider.impl.ContentSecurityPolicyProvider.HEADER_NAME;
import static org.eximeebpms.bpm.webapp.impl.security.filter.headersec.provider.impl.ContentSecurityPolicyProvider.HEADER_NONCE_PLACEHOLDER;
...
@TestPropertySource(properties = {
    "eximeebpms.bpm.webapp.applicationPath=" + ChangedAppPathIT.MY_APP_PATH
})
