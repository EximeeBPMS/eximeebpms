...
import org.eximeebpms.bpm.engine.form.FormType;
...
import org.eximeebpms.bpm.engine.runtime.MessageCorrelationResultWithVariables;
...
import org.eximeebpms.bpm.engine.task.TaskCountByCandidateGroupResult;
...
public abstract class MockProvider {
  ...
  public static final Query EXAMPLE_FILTER_QUERY = new TaskQueryImpl().taskName("test").processVariableValueEquals("foo", "bar").taskVariableValueEquals("foo", "bar");
