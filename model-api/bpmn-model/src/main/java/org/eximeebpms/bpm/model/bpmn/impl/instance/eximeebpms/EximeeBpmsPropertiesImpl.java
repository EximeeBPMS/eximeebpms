...
import static org.eximeebpms.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ELEMENT_PROPERTIES;
 ...
 */
public class EximeeBpmsPropertiesImpl extends BpmnModelElementInstanceImpl implements EximeeBpmsProperties {

  protected static ChildElementCollection<EximeeBpmsProperty> camundaPropertyCollection;

  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(EximeeBpmsProperties.class, CAMUNDA_ELEMENT_PROPERTIES)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(EximeeBpmsPropertiesImpl::new);

    SequenceBuilder sequenceBuilder = typeBuilder.sequence();

    camundaPropertyCollection = sequenceBuilder.elementCollection(EximeeBpmsProperty.class)
      .build();

    typeBuilder.build();
  }

  public EximeeBpmsPropertiesImpl(ModelTypeInstanceContext instanceContext) {
    super(instanceContext);
  }

  public Collection<EximeeBpmsProperty> getEximeeBpmsProperties() {
