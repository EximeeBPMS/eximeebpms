 ...
 */
package org.eximeebpms.bpm.engine.task;
...
public interface TaskQuery extends Query<TaskQuery, Task> {
   ...
   * The syntax is that of SQL: for example usage: nameLike(%eximeebpms%).
   * The query will match the names of tasks in a case-insensitive way.
   */
   ...
   * The syntax is that of SQL: for example usage: nameNotLike(%eximeebpms%)
   * The query will match the names of tasks in a case-insensitive way.
   */
   ...
   * The syntax is that of SQL: for example usage: descriptionLike(%eximeebpms%)
   * The query will match the descriptions of tasks in a case-insensitive way.
   */
   ...
   * The syntax is that of SQL: for example usage: processInstanceBusinessKeyLikeExpression("${ '%eximeebpms%' }")
   */
   ...
   * The syntax is that of SQL: for example usage: taskDefinitionKeyLike("%eximeebpms%").
   * The task definition key is the id of the userTask:
   * &lt;userTask id="xxx" .../&gt;
   **/
   ...
   * {@link Task#getFormKey()} and {@link Task#getEximeeBpmsFormRef()} will return a value (in
