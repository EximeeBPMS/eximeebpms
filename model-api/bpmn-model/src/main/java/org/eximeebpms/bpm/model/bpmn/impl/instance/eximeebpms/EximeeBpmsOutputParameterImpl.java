 ...
 */
public class EximeeBpmsOutputParameterImpl extends EximeeBpmsGenericValueElementImpl implements EximeeBpmsOutputParameter {

  protected static Attribute<String> camundaNameAttribute;

  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(EximeeBpmsOutputParameter.class, CAMUNDA_ELEMENT_OUTPUT_PARAMETER)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(EximeeBpmsOutputParameterImpl::new);
  ...
  public EximeeBpmsOutputParameterImpl(ModelTypeInstanceContext instanceContext) {
