 ...
 */
package org.eximeebpms.bpm.quarkus.engine.extension.deployment.impl;
...
import org.eximeebpms.bpm.engine.cdi.ProcessVariables;
...
import org.eximeebpms.bpm.engine.cdi.impl.context.DefaultContextAssociationManager;
...
import org.eximeebpms.bpm.quarkus.engine.extension.impl.EximeeBpmsEngineRecorder;
import org.eximeebpms.bpm.quarkus.engine.extension.impl.InjectableBusinessProcessContext;
import org.jboss.jandex.DotName;

public class EximeeBpmsEngineProcessor {

  protected static final String FEATURE = "eximeebpms-platform-engine";
  ...
  @BuildStep
  @Record(RUNTIME_INIT)
  protected void cdiConfig(EximeeBpmsEngineRecorder recorder, BeanContainerBuildItem beanContainer) {
  ...
  @BuildStep
  @Record(RUNTIME_INIT)
  protected void processEngine(EximeeBpmsEngineRecorder recorder,
  ...
  @BuildStep
  @Record(RUNTIME_INIT)
  protected void deployProcessEngineResources(EximeeBpmsEngineRecorder recorder) {
    recorder.fireEximeeBpmsEngineStartEvent();
  }

  @BuildStep
  @Record(RUNTIME_INIT)
  protected void shutdown(EximeeBpmsEngineRecorder recorder,
