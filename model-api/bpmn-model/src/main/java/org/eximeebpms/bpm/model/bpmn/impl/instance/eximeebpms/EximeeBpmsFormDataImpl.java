...
import static org.eximeebpms.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ELEMENT_FORM_DATA;
 ...
 */
public class EximeeBpmsFormDataImpl extends BpmnModelElementInstanceImpl implements EximeeBpmsFormData {

  protected static ChildElementCollection<EximeeBpmsFormField> camundaFormFieldCollection;

  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(EximeeBpmsFormData.class, CAMUNDA_ELEMENT_FORM_DATA)
      .namespaceUri(BpmnModelConstants.CAMUNDA_NS)
      .instanceProvider(EximeeBpmsFormDataImpl::new);

    SequenceBuilder sequenceBuilder = typeBuilder.sequence();

    camundaFormFieldCollection = sequenceBuilder.elementCollection(EximeeBpmsFormField.class)
      .build();

    typeBuilder.build();
  }

  public EximeeBpmsFormDataImpl(ModelTypeInstanceContext instanceContext) {
    super(instanceContext);
  }

  public Collection<EximeeBpmsFormField> getEximeeBpmsFormFields() {
