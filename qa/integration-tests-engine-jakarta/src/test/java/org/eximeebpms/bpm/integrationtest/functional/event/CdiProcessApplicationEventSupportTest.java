 ...
 */
package org.eximeebpms.bpm.integrationtest.functional.event;

import org.eximeebpms.bpm.engine.runtime.ProcessInstance;
import org.eximeebpms.bpm.engine.task.Task;
import org.eximeebpms.bpm.integrationtest.functional.event.beans.CdiEventSupportProcessApplication;
import org.eximeebpms.bpm.integrationtest.functional.event.beans.EventObserverCdiBean;
import org.eximeebpms.bpm.integrationtest.functional.event.beans.ExecutionListenerProcessApplication;
...
public class CdiProcessApplicationEventSupportTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive createDeployment() {
    WebArchive archive = ShrinkWrap.create(WebArchive.class, "test.war")
        ...
        .addAsResource("org/eximeebpms/bpm/integrationtest/functional/event/ProcessApplicationEventSupportTest.testExecutionListener.bpmn20.xml");
