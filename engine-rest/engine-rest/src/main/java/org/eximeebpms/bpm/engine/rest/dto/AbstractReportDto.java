...
import org.eximeebpms.bpm.engine.query.Report;
import org.eximeebpms.bpm.engine.rest.dto.converter.PeriodUnitConverter;
...
public abstract class AbstractReportDto<T extends Report> extends AbstractSearchQueryDto {
  ...
  @EximeeBPMSQueryParam("reportType")
  ...
  @EximeeBPMSQueryParam(value = "periodUnit", converter = PeriodUnitConverter.class)
