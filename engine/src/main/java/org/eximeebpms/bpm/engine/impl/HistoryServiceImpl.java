...
import org.eximeebpms.bpm.engine.impl.cmd.DeleteHistoricVariableInstancesByProcessInstanceIdCmd;
import org.eximeebpms.bpm.engine.impl.cmd.DeleteUserOperationLogEntryCmd;
import org.eximeebpms.bpm.engine.impl.cmd.FindHistoryCleanupJobsCmd;
import org.eximeebpms.bpm.engine.impl.cmd.GetHistoricExternalTaskLogErrorDetailsCmd;
import org.eximeebpms.bpm.engine.impl.cmd.GetHistoricJobLogExceptionStacktraceCmd;
import org.eximeebpms.bpm.engine.impl.cmd.HistoryCleanupCmd;
import org.eximeebpms.bpm.engine.impl.cmd.batch.DeleteHistoricProcessInstancesBatchCmd;
import org.eximeebpms.bpm.engine.impl.dmn.cmd.DeleteHistoricDecisionInstanceByDefinitionIdCmd;
import org.eximeebpms.bpm.engine.impl.dmn.cmd.DeleteHistoricDecisionInstanceByInstanceIdCmd;
import org.eximeebpms.bpm.engine.impl.dmn.cmd.DeleteHistoricDecisionInstancesBatchCmd;
import org.eximeebpms.bpm.engine.impl.dmn.cmd.DeleteHistoricDecisionInstancesBulkCmd;
import org.eximeebpms.bpm.engine.history.SetRemovalTimeToHistoricProcessInstancesBuilder;
import org.eximeebpms.bpm.engine.impl.history.SetRemovalTimeToHistoricBatchesBuilderImpl;
import org.eximeebpms.bpm.engine.impl.history.SetRemovalTimeToHistoricDecisionInstancesBuilderImpl;
import org.eximeebpms.bpm.engine.impl.history.SetRemovalTimeToHistoricProcessInstancesBuilderImpl;
