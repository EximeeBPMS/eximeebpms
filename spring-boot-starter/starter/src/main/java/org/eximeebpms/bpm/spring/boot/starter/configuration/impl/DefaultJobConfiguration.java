 ...
 */
public class DefaultJobConfiguration extends AbstractEximeeBpmsConfiguration implements EximeeBpmsJobConfiguration {
  ...
  public static class JobConfiguration {
    ...
    public static final String EXIMEEBPMS_TASK_EXECUTOR_QUALIFIER = "eximeeBpmsTaskExecutor";

    @Deprecated
    public static final String CAMUNDA_TASK_EXECUTOR_QUALIFIER = "camundaTaskExecutor";

    @Bean(name = {EXIMEEBPMS_TASK_EXECUTOR_QUALIFIER, "camundaTaskExecutor"})
    @ConditionalOnMissingBean(name = {EXIMEEBPMS_TASK_EXECUTOR_QUALIFIER, "camundaTaskExecutor"})
    @ConditionalOnProperty(prefix = "eximeebpms.bpm.job-execution", name = "enabled", havingValue = "true", matchIfMissing = true)
    public static TaskExecutor eximeeBpmsTaskExecutor(EximeeBpmsBpmProperties properties) {
    ...
    @ConditionalOnProperty(prefix = "eximeebpms.bpm.job-execution", name = "enabled", havingValue = "true", matchIfMissing = true)
    public static JobExecutor jobExecutor(@Qualifier(EXIMEEBPMS_TASK_EXECUTOR_QUALIFIER) final TaskExecutor taskExecutor, EximeeBpmsBpmProperties properties) {
