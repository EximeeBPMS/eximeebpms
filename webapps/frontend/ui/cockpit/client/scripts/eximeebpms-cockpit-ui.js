...
require('eximeebpms-commons-ui/vendor/bootstrap');

var commons = require('eximeebpms-commons-ui/lib');
var sdk = require('eximeebpms-bpm-sdk-js/lib/angularjs/index');
...
var lodash = require('eximeebpms-commons-ui/vendor/lodash');
...
export function exposePackages(container) {
  ...
  container.jquery = $;
  container['eximeebpms-commons-ui'] = commons;
  container['eximeebpms-bpm-sdk-js'] = sdk;
