...
import static org.eximeebpms.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_RESOURCE;
import static org.eximeebpms.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_SCRIPT_FORMAT;
import static org.eximeebpms.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ELEMENT_SCRIPT;
 ...
 */
public class EximeeBpmsScriptImpl extends BpmnModelElementInstanceImpl implements EximeeBpmsScript {
  ...
  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(EximeeBpmsScript.class, CAMUNDA_ELEMENT_SCRIPT)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(EximeeBpmsScriptImpl::new);
  ...
  public EximeeBpmsScriptImpl(ModelTypeInstanceContext instanceContext) {
    super(instanceContext);
  }

  public String getEximeeBpmsScriptFormat() {
    return camundaScriptFormatAttribute.getValue(this);
  }

  public void setEximeeBpmsScriptFormat(String camundaScriptFormat) {
