...
import org.eximeebpms.bpm.container.impl.jboss.util.JBossCompatibilityExtension;
import org.eximeebpms.bpm.container.impl.jboss.util.Tccl;
import org.eximeebpms.bpm.container.impl.jboss.util.Tccl.Operation;
...
public class MscManagedProcessEngineController extends MscManagedProcessEngine {
  ...
  private Object createInstance(String configurationClassName) {
    try {
      ...
      throw new ProcessEngineException("Could not load '"+configurationClassName+"': the class must be visible from the eximeebpms-wildfly-subsystem module.", e);
    }
  }
