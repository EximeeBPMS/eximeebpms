 ...
 */
public class EximeeBpmsOutImpl extends BpmnModelElementInstanceImpl implements EximeeBpmsOut {
  ...
  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(EximeeBpmsOut.class, CAMUNDA_ELEMENT_OUT)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(EximeeBpmsOutImpl::new);
  ...
  public EximeeBpmsOutImpl(ModelTypeInstanceContext instanceContext) {
