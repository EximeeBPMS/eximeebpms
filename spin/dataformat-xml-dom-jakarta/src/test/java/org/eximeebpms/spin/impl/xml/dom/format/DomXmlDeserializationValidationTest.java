...
public class DomXmlDeserializationValidationTest {
  ...
  public void shouldValidateBaseTypeOnlyForComplexClass() {
    ...
    // then
    Mockito.verify(validator).validate("org.eximeebpms.spin.impl.xml.dom.format.DomXmlDeserializationValidationTest$Complex");
    Mockito.verifyNoMoreInteractions(validator);
  }
  ...
  public void shouldFailForComplexClass() {
    ...
    // then
    thrown.expect(SpinRuntimeException.class);
    thrown.expectMessage("'org.eximeebpms.spin.impl.xml.dom.format.DomXmlDeserializationValidationTest$Complex'");
