 ...
 */
public class EximeeBpmsInputParameterTest extends BpmnModelElementInstanceTest {
  ...
  public void testIntputParameterScriptChildAssignment() {
    try {
      ...
      fail("EximeeBpmsScript should be accepted as a child element of EximeeBpmsInputParameter. Error: " + e.getMessage());
    }
  }
  ...
  public void testInputParameterListChildAssignment() {
    try {
      ...
      fail("EximeeBpmsList should be accepted as a child element of EximeeBpmsInputParameter. Error: " + e.getMessage());
    }
  }
  ...
  public void testInputParameterMapChildAssignment() {
    try {
      ...
      fail("EximeeBpmsMap should be accepted as a child element of EximeeBpmsInputParameter. Error: " + e.getMessage());
    }
  }
}
