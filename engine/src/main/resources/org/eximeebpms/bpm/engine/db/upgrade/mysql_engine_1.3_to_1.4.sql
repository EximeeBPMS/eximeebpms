...
alter table ACT_RU_VARIABLE drop foreign key ACT_FK_VAR_CASE_EXE;
alter table ACT_RU_VARIABLE drop foreign key ACT_FK_VAR_CASE_INST;
alter table ACT_RU_TASK drop foreign key ACT_FK_TASK_CASE_EXE;
alter table ACT_RU_TASK drop foreign key ACT_FK_TASK_CASE_DEF;
