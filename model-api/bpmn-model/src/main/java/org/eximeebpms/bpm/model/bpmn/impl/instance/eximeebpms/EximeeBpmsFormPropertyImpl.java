 ...
 */
public class EximeeBpmsFormPropertyImpl extends BpmnModelElementInstanceImpl implements EximeeBpmsFormProperty {
  ...
  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(EximeeBpmsFormProperty.class, CAMUNDA_ELEMENT_FORM_PROPERTY)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(EximeeBpmsFormPropertyImpl::new);
  ...
  public EximeeBpmsFormPropertyImpl(ModelTypeInstanceContext instanceContext) {
