...
import static org.eximeebpms.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ELEMENT_FAILED_JOB_RETRY_TIME_CYCLE;
 ...
 */
public class EximeeBpmsFailedJobRetryTimeCycleImpl extends BpmnModelElementInstanceImpl implements EximeeBpmsFailedJobRetryTimeCycle {

  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(EximeeBpmsFailedJobRetryTimeCycle.class, CAMUNDA_ELEMENT_FAILED_JOB_RETRY_TIME_CYCLE)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(EximeeBpmsFailedJobRetryTimeCycleImpl::new);

    typeBuilder.build();
  }

  public EximeeBpmsFailedJobRetryTimeCycleImpl(ModelTypeInstanceContext instanceContext) {
