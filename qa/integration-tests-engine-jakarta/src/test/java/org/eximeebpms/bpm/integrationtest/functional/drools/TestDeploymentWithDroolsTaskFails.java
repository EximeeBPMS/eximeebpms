 ...
 */
package org.eximeebpms.bpm.integrationtest.functional.drools;
...
public class TestDeploymentWithDroolsTaskFails {
  ...
  public static WebArchive processArchive() {
    ...
    return  ShrinkWrap.create(WebArchive.class, "test.war")
      ...
      .addAsResource("org/eximeebpms/bpm/integrationtest/functional/drools/TestDeploymentWithDroolsTaskFails.testDeployDroolsFails.bpmn20.xml");
  }
