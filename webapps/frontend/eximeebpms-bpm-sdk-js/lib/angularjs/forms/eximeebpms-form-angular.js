...
var EximeebpmsForm = require('../../forms/eximeebpms-form');

var angular = require('angular');
var $ = EximeebpmsForm.$;
var constants = require('./../../forms/constants');

var EximeebpmsFormAngular = EximeebpmsForm.extend({
  renderForm: function () {
    var self = this;
    ...
    EximeebpmsForm.prototype.renderForm.apply(this, arguments);
  ...
  fireEvent: function () {
    ...
    var doFireEvent = function () {
      EximeebpmsForm.prototype.fireEvent.apply(self, args);
    };
...
module.exports = EximeebpmsFormAngular;
