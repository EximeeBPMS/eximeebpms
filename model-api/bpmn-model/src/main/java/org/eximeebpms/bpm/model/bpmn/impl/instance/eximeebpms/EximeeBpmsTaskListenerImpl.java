...
import static org.eximeebpms.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ELEMENT_TASK_LISTENER;
 ...
 */
public class EximeeBpmsTaskListenerImpl extends BpmnModelElementInstanceImpl implements EximeeBpmsTaskListener {
  ...
  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(EximeeBpmsTaskListener.class, CAMUNDA_ELEMENT_TASK_LISTENER)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(EximeeBpmsTaskListenerImpl::new);
  ...
  public EximeeBpmsTaskListenerImpl(ModelTypeInstanceContext instanceContext) {
