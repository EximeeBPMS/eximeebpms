 ...
 */
package org.eximeebpms.bpm.engine.impl.db.entitymanager;

import static org.eximeebpms.bpm.engine.impl.db.entitymanager.cache.DbEntityState.DELETED_MERGED;
import static org.eximeebpms.bpm.engine.impl.db.entitymanager.cache.DbEntityState.DELETED_PERSISTENT;
import static org.eximeebpms.bpm.engine.impl.db.entitymanager.cache.DbEntityState.DELETED_TRANSIENT;
...
import org.eximeebpms.bpm.engine.impl.ExecutionQueryImpl;
import org.eximeebpms.bpm.engine.impl.GroupQueryImpl;
import org.eximeebpms.bpm.engine.impl.HistoricActivityInstanceQueryImpl;
import org.eximeebpms.bpm.engine.impl.HistoricDetailQueryImpl;
import org.eximeebpms.bpm.engine.impl.HistoricJobLogQueryImpl;
import org.eximeebpms.bpm.engine.impl.HistoricProcessInstanceQueryImpl;
import org.eximeebpms.bpm.engine.impl.HistoricTaskInstanceQueryImpl;
import org.eximeebpms.bpm.engine.impl.HistoricVariableInstanceQueryImpl;
import org.eximeebpms.bpm.engine.impl.JobQueryImpl;
import org.eximeebpms.bpm.engine.impl.Page;
import org.eximeebpms.bpm.engine.impl.ProcessDefinitionQueryImpl;
...
import org.eximeebpms.bpm.engine.impl.db.EntityLoadListener;
import org.eximeebpms.bpm.engine.impl.db.FlushResult;
import org.eximeebpms.bpm.engine.impl.db.HistoricEntity;
...
import org.eximeebpms.bpm.engine.impl.db.entitymanager.cache.DbEntityCache;
...
import org.eximeebpms.bpm.engine.impl.db.entitymanager.operation.DbOperation.State;
import org.eximeebpms.bpm.engine.impl.db.entitymanager.operation.DbOperationManager;
import org.eximeebpms.bpm.engine.impl.db.entitymanager.operation.DbOperationType;
import org.eximeebpms.bpm.engine.impl.identity.db.DbGroupQueryImpl;
import org.eximeebpms.bpm.engine.impl.identity.db.DbUserQueryImpl;
import org.eximeebpms.bpm.engine.impl.interceptor.Session;
import org.eximeebpms.bpm.engine.impl.jobexecutor.JobExecutorContext;
