 ...
 *    <li>Bootstrapping through {@link org.eximeebpms.bpm.application.impl.ServletProcessApplication}. In this case we have access to the {@link ServletContext}
...
public class SpringProcessApplicationElResolver implements ProcessApplicationElResolver {
  ...
  public ELResolver getElResolver(AbstractProcessApplication processApplication) {
    ...
    } else if (processApplication instanceof org.eximeebpms.bpm.application.impl.ServletProcessApplication) {
      // Using fully-qualified class name instead of import statement to allow for automatic transformation
      org.eximeebpms.bpm.application.impl.ServletProcessApplication servletProcessApplication = (org.eximeebpms.bpm.application.impl.ServletProcessApplication) processApplication;
