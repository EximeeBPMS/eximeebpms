...
public class SessionCookieTest {
  ...
  public void shouldConfigureDefault() {
    ...
    // then
    assertThat(headerRule.getCookieHeader()).matches(headerRule.getSessionCookieRegex("eximeebpms", "Lax", false));
  }
  ...
  public void shouldConfigureSecureEnabled() {
    ...
    // then
    assertThat(headerRule.getCookieHeader()).matches(headerRule.getSessionCookieRegex("eximeebpms", "Lax", true));
  }
  ...
  public void shouldConfigureSameSiteDisabled() {
    ...
    // then
    assertThat(headerRule.getCookieHeader()).matches(headerRule.getSessionCookieRegex("eximeebpms", null, false));
  }
  ...
  public void shouldConfigureSameSiteOptionStrict() {
    ...
    // then
    assertThat(headerRule.getCookieHeader()).matches(headerRule.getSessionCookieRegex("eximeebpms", "Strict", false));
  }
  ...
  public void shouldConfigureSameSiteCustomValue() {
    ...
    // then
    assertThat(headerRule.getCookieHeader()).matches(headerRule.getSessionCookieRegex("eximeebpms", "aCustomValue", false));
  }
  ...
  public void shouldConfigureCookieName() {
    ...
    // then
    assertThat(headerRule.getCookieHeader()).matches(headerRule.getSessionCookieRegex("eximeebpms", "MYCOOKIENAME", "Lax", false));
  }
