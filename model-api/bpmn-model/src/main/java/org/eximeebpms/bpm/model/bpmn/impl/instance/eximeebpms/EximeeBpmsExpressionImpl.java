...
import static org.eximeebpms.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ELEMENT_EXPRESSION;
 ...
 */
public class EximeeBpmsExpressionImpl extends BpmnModelElementInstanceImpl implements EximeeBpmsExpression {

  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(EximeeBpmsExpression.class, CAMUNDA_ELEMENT_EXPRESSION)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(EximeeBpmsExpressionImpl::new);

    typeBuilder.build();
  }

  public EximeeBpmsExpressionImpl(ModelTypeInstanceContext instanceContext) {
