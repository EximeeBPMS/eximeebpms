...
import org.eximeebpms.bpm.engine.test.assertions.AssertionsLogger;
...
public class ProcessInstanceAssert extends AbstractProcessAssert<ProcessInstanceAssert, ProcessInstance> {
  ...
  private ProcessInstanceAssert isWaitingAt(final String[] activityIds, boolean isWaitingAt, boolean exactly) {
    ...
    Stream<String> descendantActivityIdStream = flattendActivityInstances.flatMap(this::getActivityIdAndCollectTransitions);
   ...
   * @throws  org.eximeebpms.bpm.engine.ProcessEngineException in case more
   ...
   * @return  TaskAssert inspecting the only task available. Inspecting a
   *          'null' Task in case no such Task is available.
   * @throws  org.eximeebpms.bpm.engine.ProcessEngineException in case more than one
   ...
   *          available.
   * @throws  org.eximeebpms.bpm.engine.ProcessEngineException in case more than
