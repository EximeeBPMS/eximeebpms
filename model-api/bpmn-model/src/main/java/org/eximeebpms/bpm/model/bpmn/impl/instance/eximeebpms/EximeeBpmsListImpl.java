...
import static org.eximeebpms.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ELEMENT_LIST;
...
import org.eximeebpms.bpm.model.xml.UnsupportedModelOperationException;
import org.eximeebpms.bpm.model.xml.impl.instance.ModelTypeInstanceContext;
import org.eximeebpms.bpm.model.xml.impl.util.ModelUtil;
import org.eximeebpms.bpm.model.xml.instance.DomElement;
import org.eximeebpms.bpm.model.xml.type.ModelElementTypeBuilder;

/**
 * @author Sebastian Menski
 */
public class EximeeBpmsListImpl extends BpmnModelElementInstanceImpl implements EximeeBpmsList {

  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(EximeeBpmsList.class, CAMUNDA_ELEMENT_LIST)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(EximeeBpmsListImpl::new);

    typeBuilder.build();
  }

  public EximeeBpmsListImpl(ModelTypeInstanceContext instanceContext) {
