...
public interface EximeeBpmsField extends BpmnModelElementInstance {
  ...
  String getEximeeBpmsStringValue();

  void setEximeeBpmsStringValue(String camundaStringValue);

  EximeeBpmsString getEximeeBpmsString();

  void setEximeeBpmsString(EximeeBpmsString camundaString);

  EximeeBpmsExpression getEximeeBpmsExpressionChild();
