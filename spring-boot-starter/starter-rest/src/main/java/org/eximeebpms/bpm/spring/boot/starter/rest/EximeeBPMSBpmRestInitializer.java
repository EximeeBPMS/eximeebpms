 ...
 */
public class EximeeBPMSBpmRestInitializer implements ServletContextInitializer {

  private static final Logger log = LoggerFactory.getLogger(EximeeBPMSBpmRestInitializer.class);
  ...
  public EximeeBPMSBpmRestInitializer(JerseyApplicationPath applicationPath, EximeeBPMSBpmProperties properties) {
