...
import org.eximeebpms.bpm.engine.telemetry.Database;
import org.eximeebpms.bpm.engine.telemetry.Internals;
import org.eximeebpms.bpm.engine.telemetry.Jdk;
import org.eximeebpms.bpm.engine.telemetry.Product;
...
public class TelemetryRestServiceTest extends AbstractRestServiceTest {
  ...
  public void shouldGetTelemetryData() throws JsonProcessingException {
    ...
    .then()
      .expect()
        ...
        .body("product.internals.license-key.features.eximeebpmsBPM", equalTo("true"))
        ...
        .body("product.internals.eximeebpms-integration[0]", equalTo("spring-boot"))
  ...
  public void shouldGetMinimalTelemetryData() {
    ...
    when(internals.getEximeeBpmsIntegration()).thenReturn(new HashSet<>());
