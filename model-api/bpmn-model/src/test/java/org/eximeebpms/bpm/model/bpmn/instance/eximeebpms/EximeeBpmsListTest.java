...
public class EximeeBpmsListTest extends BpmnModelElementInstanceTest {
  ...
  public void testListValueChildAssignment() {
    try {
      ...
      EximeeBpmsValue valueElement = modelInstance.newInstance(EximeeBpmsValue.class);
      valueElement.setTextContent("test");

      listElement.addChildElement(valueElement);

    } catch (Exception e) {
      fail("EximeeBpmsValue should be accepted as a child element of EximeeBpmsList. Error: " + e.getMessage());
    }
  }
}
