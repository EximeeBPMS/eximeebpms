...
module.exports = function(config, app) {
  return [
    function() {
      ...
      var values = JSON.parse(storage.getItem('eximeebpms-web') || '{}');
      ...
      this.set = function(key, value) {
        values[key] = value;
        storage.setItem('eximeebpms-web', JSON.stringify(values));
      };
      ...
      this.clearTranslationData = function() {
        ...
        window.localStorage.setItem('eximeebpms-web', JSON.stringify(values));
      };
