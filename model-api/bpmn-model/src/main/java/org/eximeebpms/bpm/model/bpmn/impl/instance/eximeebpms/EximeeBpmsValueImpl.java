 ...
 */
public class EximeeBpmsValueImpl extends BpmnModelElementInstanceImpl implements EximeeBpmsValue {

  protected static Attribute<String> camundaIdAttribute;
  protected static Attribute<String> camundaNameAttribute;

  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(EximeeBpmsValue.class, CAMUNDA_ELEMENT_VALUE)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(EximeeBpmsValueImpl::new);
  ...
  public EximeeBpmsValueImpl(ModelTypeInstanceContext instanceContext) {
