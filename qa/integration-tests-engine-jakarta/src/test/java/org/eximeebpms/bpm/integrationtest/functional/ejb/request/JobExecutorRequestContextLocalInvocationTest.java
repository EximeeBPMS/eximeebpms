 ...
 */
package org.eximeebpms.bpm.integrationtest.functional.ejb.request;

import org.eximeebpms.bpm.engine.runtime.ProcessInstance;
import org.eximeebpms.bpm.engine.task.Task;
import org.eximeebpms.bpm.integrationtest.functional.cdi.beans.RequestScopedDelegateBean;
import org.eximeebpms.bpm.integrationtest.functional.ejb.request.beans.InvocationCounter;
import org.eximeebpms.bpm.integrationtest.functional.ejb.request.beans.InvocationCounterDelegateBean;
import org.eximeebpms.bpm.integrationtest.functional.ejb.request.beans.InvocationCounterDelegateBeanLocal;
import org.eximeebpms.bpm.integrationtest.functional.ejb.request.beans.InvocationCounterService;
import org.eximeebpms.bpm.integrationtest.functional.ejb.request.beans.InvocationCounterServiceBean;
import org.eximeebpms.bpm.integrationtest.functional.ejb.request.beans.InvocationCounterServiceLocal;
import org.eximeebpms.bpm.integrationtest.functional.ejb.request.beans.RequestScopedSFSBDelegate;
...
public class JobExecutorRequestContextLocalInvocationTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    return initWebArchiveDeployment()
      ...
      .addAsResource("org/eximeebpms/bpm/integrationtest/functional/ejb/request/JobExecutorRequestContextLocalInvocationTest.testContextPropagationEjbLocal.bpmn20.xml")
      .addAsWebInfResource("org/eximeebpms/bpm/integrationtest/functional/ejb/request/jboss-deployment-structure.xml","jboss-deployment-structure.xml");
  }
...
//    "global/" +
//    "service/" +
//    "InvocationCounterServiceBean!org.eximeebpms.bpm.integrationtest.functional.cdi.beans.InvocationCounterServiceLocal");
//
