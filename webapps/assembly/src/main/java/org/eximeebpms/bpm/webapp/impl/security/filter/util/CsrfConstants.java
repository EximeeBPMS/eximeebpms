...
public final class CsrfConstants {
  ...
  public static final String CSRF_SESSION_MUTEX = "EXIMEEBPMS_CSRF_SESSION_MUTEX";

  public static final String CSRF_TOKEN_SESSION_ATTR_NAME = "EXIMEEBPMS_CSRF_TOKEN";
