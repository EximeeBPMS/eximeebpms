 ...
 */
package org.eximeebpms.bpm.engine.test.standalone.db.entitymanager;

import static org.eximeebpms.bpm.engine.authorization.Authorization.ANY;
import static org.eximeebpms.bpm.engine.authorization.Authorization.AUTH_TYPE_GLOBAL;
import static org.eximeebpms.bpm.engine.authorization.Authorization.AUTH_TYPE_GRANT;
import static org.eximeebpms.bpm.engine.impl.test.TestHelper.assertAndEnsureCleanDbAndCache;
...
public class PurgeDatabaseTest {
  ...
  public void testPurgeDmnProcess() {
    ...
    engineRule.getRepositoryService()
      .createDeployment()
      .addClasspathResource("org/eximeebpms/bpm/engine/test/standalone/db/entitymanager/PurgeDatabaseTest.testPurgeDmnProcess.dmn")
      .deploy();
    VariableMap variables = Variables.createVariables()
      .putValue("key", "value")
