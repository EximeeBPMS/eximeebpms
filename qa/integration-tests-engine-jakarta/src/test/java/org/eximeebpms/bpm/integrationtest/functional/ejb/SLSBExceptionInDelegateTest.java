 ...
 */
package org.eximeebpms.bpm.integrationtest.functional.ejb;
...
import org.eximeebpms.bpm.integrationtest.functional.ejb.beans.SLSBClientDelegate;
import org.eximeebpms.bpm.integrationtest.functional.ejb.beans.SLSBThrowExceptionDelegate;
...
public class SLSBExceptionInDelegateTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    return initWebArchiveDeployment().addClass(SLSBThrowExceptionDelegate.class).addClass(SLSBClientDelegate.class)
        .addAsResource("org/eximeebpms/bpm/integrationtest/functional/ejb/SLSBExceptionInDelegateTest.testOriginalExceptionFromEjbReachesCaller.bpmn20.xml")
        .addAsResource("org/eximeebpms/bpm/integrationtest/functional/ejb/SLSBExceptionInDelegateTest.callProcess.bpmn20.xml");
  }
