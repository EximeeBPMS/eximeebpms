 ...
 */
package org.eximeebpms.bpm.engine.test.cmmn.transformer;
...
import org.eximeebpms.bpm.engine.impl.cmmn.transformer.CmmnTransform;
...
public class CmmnTransformerTest {
  ...
  protected List<CaseDefinitionEntity> transform() {
    ...
    byte[] model = org.eximeebpms.bpm.engine.impl.util.IoUtil.readInputStream(inputStream, "model");
