...
import org.eximeebpms.bpm.engine.rest.standalone.NoServletAuthenticationFilterTest;
import org.eximeebpms.bpm.engine.rest.standalone.NoServletEmptyBodyFilterTest;
import org.eximeebpms.bpm.engine.rest.standalone.ServletAuthenticationFilterTest;
import org.eximeebpms.bpm.engine.rest.standalone.ServletEmptyBodyFilterTest;
  ...
  static {
    ...
    TEST_RULE_FACTORIES.put(ServletAuthenticationFilterTest.class, new UndertowServletContainerRuleFactory(
        Servlets.deployment()
            ...
            .addFilter(Servlets.filter("eximeebpms-auth", ProcessEngineAuthenticationFilter.class)
                .addInitParam("authentication-provider",
                    "org.eximeebpms.bpm.engine.rest.security.auth.impl.HttpBasicAuthenticationProvider"))
            .addFilterUrlMapping("eximeebpms-auth", "/*", DispatcherType.REQUEST)
            .addServlet(Servlets.servlet("eximeebpms-app", HttpServletDispatcher.class)
                .addMapping("/*")
                .addInitParam("jakarta.ws.rs.Application",
                    "org.eximeebpms.bpm.engine.rest.util.container.JaxrsApplication"))));
    ...
    TEST_RULE_FACTORIES.put(ServletEmptyBodyFilterTest.class, new UndertowServletContainerRuleFactory(
        Servlets.deployment()
            ...
            .setClassLoader(ResteasyUndertowServerBootstrap.class.getClassLoader())
            .addListener(Servlets.listener(ResteasyBootstrap.class))
            .addFilter(Servlets.filter("EmptyBodyFilter", org.eximeebpms.bpm.engine.rest.filter.EmptyBodyFilter.class)
                .addInitParam("rest-url-pattern-prefix", ""))
    ...
    TEST_RULE_FACTORIES.put(CustomJacksonDateFormatTest.class, new UndertowServletContainerRuleFactory(
        Servlets.deployment()
            ...
            .setClassLoader(ResteasyUndertowServerBootstrap.class.getClassLoader())
            .addListener(Servlets.listener(ResteasyBootstrap.class))
            .addListener(Servlets.listener(org.eximeebpms.bpm.engine.rest.CustomJacksonDateFormatListener.class))
            .addInitParameter("org.eximeebpms.bpm.engine.rest.jackson.dateFormat", "yyyy-MM-dd'T'HH:mm:ss")
            .addFilter(Servlets.filter("Resteasy", FilterDispatcher.class)
                .addInitParam("jakarta.ws.rs.Application",
                    "org.eximeebpms.bpm.engine.rest.util.container.JaxrsApplication"))
            .addFilterUrlMapping("Resteasy", "/*", DispatcherType.REQUEST)));
