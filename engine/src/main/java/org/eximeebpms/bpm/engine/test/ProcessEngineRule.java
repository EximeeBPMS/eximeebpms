 ...
 * initialized by default with the eximeebpms.cfg.xml resource on the classpath. To
 ...
 * {@link ProcessEngineRule#manageDeployment(org.eximeebpms.bpm.engine.repository.Deployment)}
...
public class ProcessEngineRule extends TestWatcher implements ProcessEngineServices {
  ...
  public void manageDeployment(org.eximeebpms.bpm.engine.repository.Deployment deployment) {
