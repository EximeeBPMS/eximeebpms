...
var $ = (window.jQuery = window.$ = require('jquery')),
  ...
  camCommonsUi = require('eximeebpms-commons-ui/lib'),
  sdk = require('eximeebpms-bpm-sdk-js/lib/angularjs/index'),
  angular = require('eximeebpms-commons-ui/vendor/angular'),
  camCommon = require('../../../common/scripts/module'),
  lodash = require('eximeebpms-commons-ui/vendor/lodash'),
  moment = require('eximeebpms-commons-ui/vendor/moment');
...
export function exposePackages(requirePackages) {
  ...
  requirePackages['eximeebpms-commons-ui'] = camCommonsUi;
  requirePackages['eximeebpms-bpm-sdk-js'] = sdk;
