...
public interface FormData {
   ...
   *
   * A form can be referenced either through a form key or through a {@link EximeeBpmsFormRef}.
   *
   */
  String getFormKey();

  /**
   * User-defined reference to a form. A {@link EximeeBpmsFormRef} can specify any
   ...
   *
   */
  EximeeBpmsFormRef getEximeeBpmsFormRef();
