...
import static org.eximeebpms.bpm.engine.impl.history.event.HistoryEventTypes.ACTIVITY_INSTANCE_END;
...
import static org.eximeebpms.bpm.engine.impl.history.event.HistoryEventTypes.PROCESS_INSTANCE_MIGRATE;
import static org.eximeebpms.bpm.engine.impl.history.event.HistoryEventTypes.TASK_INSTANCE_COMPLETE;
import static org.eximeebpms.bpm.engine.impl.history.event.HistoryEventTypes.TASK_INSTANCE_CREATE;
import static org.eximeebpms.bpm.engine.impl.history.event.HistoryEventTypes.TASK_INSTANCE_DELETE;
import static org.eximeebpms.bpm.engine.impl.history.event.HistoryEventTypes.TASK_INSTANCE_MIGRATE;
import static org.eximeebpms.bpm.engine.impl.history.event.HistoryEventTypes.TASK_INSTANCE_UPDATE;
