...
public class EximeeBPMSBpmRestJerseyAutoConfiguration {
  ...
  @Bean
  public EximeeBPMSBpmRestInitializer eximeeBPMSBpmRestInitializer(JerseyApplicationPath applicationPath, EximeeBPMSBpmProperties props) {
    return new EximeeBPMSBpmRestInitializer(applicationPath, props);
  }
}
