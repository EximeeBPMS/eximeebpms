...
import static org.eximeebpms.bpm.spring.boot.starter.property.EximeeBPMSBpmProperties.PREFIX;
 ...
 */
public class EximeeBPMSBpmVersion implements Supplier<String> {
  ...
  public EximeeBPMSBpmVersion() {
    this(ProcessEngine.class.getPackage());
  }

  EximeeBPMSBpmVersion(final Package pkg) {
