...
import org.eximeebpms.bpm.spring.boot.starter.security.oauth2.impl.OAuth2GrantedAuthoritiesMapper;
...
@AutoConfigureAfter({EximeeBpmsBpmAutoConfiguration.class, SpringProcessEngineServicesConfiguration.class})
...
public class EximeeBpmsSpringSecurityOAuth2AutoConfiguration {
  ...
  public EximeeBpmsSpringSecurityOAuth2AutoConfiguration(EximeeBpmsBpmProperties properties, OAuth2Properties oAuth2Properties) {
