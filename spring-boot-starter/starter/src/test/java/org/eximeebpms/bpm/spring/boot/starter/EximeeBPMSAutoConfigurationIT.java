...
import org.eximeebpms.bpm.spring.boot.starter.AdditionalCammundaBpmConfigurations.AfterStandardConfiguration;
import org.eximeebpms.bpm.spring.boot.starter.AdditionalCammundaBpmConfigurations.BeforeStandardConfiguration;
...
@SpringBootTest(
  ...
  properties = { "eximeebpms.bpm.admin-user.id=admin"}
)
public class EximeeBPMSAutoConfigurationIT extends AbstractEximeeBPMSAutoConfigurationIT {
