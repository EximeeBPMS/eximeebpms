...
import org.eximeebpms.bpm.engine.spring.ApplicationContextElResolver;
 ...
 *    <li>Bootstrapping through {@link org.eximeebpms.bpm.application.impl.JakartaServletProcessApplication}. In this case we have access to the {@link ServletContext}
...
public class SpringProcessApplicationElResolver implements ProcessApplicationElResolver {
  ...
  public ELResolver getElResolver(AbstractProcessApplication processApplication) {
    ...
    } else if (processApplication instanceof org.eximeebpms.bpm.application.impl.JakartaServletProcessApplication) {
      // Using fully-qualified class name instead of import statement to allow for automatic transformation
      org.eximeebpms.bpm.application.impl.JakartaServletProcessApplication servletProcessApplication = (org.eximeebpms.bpm.application.impl.JakartaServletProcessApplication) processApplication;
