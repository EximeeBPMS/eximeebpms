...
import org.eximeebpms.bpm.engine.rest.dto.task.*;
...
import org.eximeebpms.bpm.engine.rest.sub.task.TaskAttachmentResource;
...
public class TaskResourceImpl implements TaskResource {
  ...
  protected String getTaskFormMediaType(String taskId) {
    ...
    } else if(task.getEximeeBpmsFormRef() != null) {
      return ContentTypeUtil.getFormContentType(task.getEximeeBpmsFormRef());
    }
