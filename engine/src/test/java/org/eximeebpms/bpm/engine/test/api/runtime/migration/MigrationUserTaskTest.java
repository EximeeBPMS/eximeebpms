...
import static org.eximeebpms.bpm.engine.test.util.MigratingProcessInstanceValidationReportAssert.assertThat;
...
import org.eximeebpms.bpm.engine.test.api.runtime.migration.util.AccessModelInstanceTaskListener;
...
public class MigrationUserTaskTest {
  ...
  public void testAccessModelInNewTimeoutTaskListenerAfterMigration() {
    ...
    String sourceProcessDefinitionId = testHelper
        .deployAndGetDefinition("org/eximeebpms/bpm/engine/test/api/runtime/migration/MigrationUserTaskTest.noTimeoutTaskListener.bpmn20.xml")
        .getId();
    String targetProcessDefinitionId = testHelper
        .deployAndGetDefinition("org/eximeebpms/bpm/engine/test/api/runtime/migration/MigrationUserTaskTest.oneTimeoutTaskListener.bpmn20.xml")
        .getId();
  ...
  public void testTimeoutTaskListenerMigratedAfterMigration() {
    ...
    String sourceProcessDefinitionId = testHelper
        ...
        .getId();
    String targetProcessDefinitionId = testHelper
        .deployAndGetDefinition("org/eximeebpms/bpm/engine/test/api/runtime/migration/MigrationUserTaskTest.changedTimeoutTaskListener.bpmn20.xml")
        .getId();
  ...
  public void testAccessModelInNewTimeoutTaskListenerAfterMigrationToDifferentUserTask() {
    ...
    String sourceProcessDefinitionId = testHelper
        ...
        .getId();
    String targetProcessDefinitionId = testHelper
        .deployAndGetDefinition("org/eximeebpms/bpm/engine/test/api/runtime/migration/MigrationUserTaskTest.oneTimeoutTaskListenerDifferentTask.bpmn20.xml")
        .getId();
  ...
  public void testAccessModelInNewTimeoutTaskListenerAfterMultipleListenerMigration() {
    ...
    String sourceProcessDefinitionId = testHelper
        ...
        .getId();
    String targetProcessDefinitionId = testHelper
        .deployAndGetDefinition("org/eximeebpms/bpm/engine/test/api/runtime/migration/MigrationUserTaskTest.twoTimeoutTaskListeners.bpmn20.xml")
        .getId();
  ...
  public void testTriggeredTimeoutTaskListenerNotStartedAgainAfterMigration() {
    // given
    String sourceProcessDefinitionId = testHelper
        .deployAndGetDefinition("org/eximeebpms/bpm/engine/test/api/runtime/migration/MigrationUserTaskTest.twoTimeoutTaskListenersPastDate.bpmn20.xml")
        .getId();
    String targetProcessDefinitionId = testHelper
        .deployAndGetDefinition("org/eximeebpms/bpm/engine/test/api/runtime/migration/MigrationUserTaskTest.twoTimeoutTaskListenersPastDate.bpmn20.xml")
        .getId();
  ...
  public void testAccessModelInNewTimeoutTaskListenerAfterMigrationWithBoundaryEvent() {
    // given
    String sourceProcessDefinitionId = testHelper
        .deployAndGetDefinition("org/eximeebpms/bpm/engine/test/api/runtime/migration/MigrationUserTaskTest.noTimeoutTaskListenerWithBoundaryEvent.bpmn20.xml")
        .getId();
    String targetProcessDefinitionId = testHelper
        .deployAndGetDefinition("org/eximeebpms/bpm/engine/test/api/runtime/migration/MigrationUserTaskTest.oneTimeoutTaskListenerWithBoundaryEvent.bpmn20.xml")
        .getId();
  ...
  public void testTimeoutTaskListenerMigratedAfterMigrationWithBoundaryEvent() {
    ...
    String sourceProcessDefinitionId = testHelper
        ...
        .getId();
    String targetProcessDefinitionId = testHelper
        .deployAndGetDefinition("org/eximeebpms/bpm/engine/test/api/runtime/migration/MigrationUserTaskTest.changedTimeoutTaskListenerWithBoundaryEvent.bpmn20.xml")
        .getId();
