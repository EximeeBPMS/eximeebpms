...
import org.eximeebpms.bpm.integrationtest.deployment.war.beans.GroovyProcessEnginePlugin;
...
public class TestWarDeploymentWithProcessEnginePlugin extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    return initWebArchiveDeployment("test.war", "singleEngineWithProcessEnginePlugin.xml")
        ...
        .addAsResource("org/eximeebpms/bpm/integrationtest/deployment/war/groovy.bpmn20.xml")
        .addAsResource("org/eximeebpms/bpm/integrationtest/deployment/war/groovyAsync.bpmn20.xml")
