 ...
 * </p>
 */
public class EximeeBPMSBpmNestedRuntimeException extends NestedRuntimeException {
   ...
   */
  public EximeeBPMSBpmNestedRuntimeException(final String msg) {
    super(msg);
  }
   ...
   */
  public EximeeBPMSBpmNestedRuntimeException(final String msg, final Throwable cause) {
    super(msg, cause);
  }
