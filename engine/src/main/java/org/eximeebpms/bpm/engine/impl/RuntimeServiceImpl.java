...
import org.eximeebpms.bpm.engine.impl.cmd.CreateIncidentCmd;
import org.eximeebpms.bpm.engine.impl.cmd.DeleteProcessInstanceCmd;
import org.eximeebpms.bpm.engine.impl.cmd.DeleteProcessInstancesCmd;
import org.eximeebpms.bpm.engine.impl.cmd.FindActiveActivityIdsCmd;
import org.eximeebpms.bpm.engine.impl.cmd.GetActivityInstanceCmd;
import org.eximeebpms.bpm.engine.impl.cmd.GetExecutionVariableCmd;
import org.eximeebpms.bpm.engine.impl.cmd.GetExecutionVariableTypedCmd;
import org.eximeebpms.bpm.engine.impl.cmd.GetExecutionVariablesCmd;
...
import org.eximeebpms.bpm.engine.impl.cmd.PatchExecutionVariablesCmd;
import org.eximeebpms.bpm.engine.impl.cmd.RemoveExecutionVariablesCmd;
import org.eximeebpms.bpm.engine.impl.cmd.ResolveIncidentCmd;
import org.eximeebpms.bpm.engine.impl.cmd.SetAnnotationForIncidentCmd;
import org.eximeebpms.bpm.engine.impl.cmd.SetExecutionVariablesCmd;
import org.eximeebpms.bpm.engine.impl.cmd.SignalCmd;
import org.eximeebpms.bpm.engine.impl.cmd.batch.DeleteProcessInstanceBatchCmd;
import org.eximeebpms.bpm.engine.impl.cmd.batch.variables.SetVariablesToProcessInstancesBatchCmd;
import org.eximeebpms.bpm.engine.impl.migration.MigrationPlanBuilderImpl;
import org.eximeebpms.bpm.engine.impl.migration.MigrationPlanExecutionBuilderImpl;
import org.eximeebpms.bpm.engine.impl.runtime.UpdateProcessInstanceSuspensionStateBuilderImpl;
...
import org.eximeebpms.bpm.engine.runtime.NativeExecutionQuery;
...
import org.eximeebpms.bpm.engine.runtime.SignalEventReceivedBuilder;
