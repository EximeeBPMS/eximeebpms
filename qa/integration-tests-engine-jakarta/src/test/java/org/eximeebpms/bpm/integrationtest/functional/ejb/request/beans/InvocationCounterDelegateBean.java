 ...
 */
package org.eximeebpms.bpm.integrationtest.functional.ejb.request.beans;
...
public class InvocationCounterDelegateBean implements JavaDelegate {
  ...
  public void execute(DelegateExecution execution) throws Exception {
    InvocationCounterService invocationCounterService = (InvocationCounterService) new InitialContext().lookup("java:global/" +
        ...
        "service/" +
        "InvocationCounterServiceBean!org.eximeebpms.bpm.integrationtest.functional.ejb.request.beans.InvocationCounterService");
