 ...
 */
public class EximeeBpmsPropertyImpl extends BpmnModelElementInstanceImpl implements EximeeBpmsProperty {
  ...
  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(EximeeBpmsProperty.class, CAMUNDA_ELEMENT_PROPERTY)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(EximeeBpmsPropertyImpl::new);
  ...
  public EximeeBpmsPropertyImpl(ModelTypeInstanceContext instanceContext) {
  ...
  public String getEximeeBpmsValue() {
    return camundaValueAttribute.getValue(this);
  }

  public void setEximeeBpmsValue(String camundaValue) {
