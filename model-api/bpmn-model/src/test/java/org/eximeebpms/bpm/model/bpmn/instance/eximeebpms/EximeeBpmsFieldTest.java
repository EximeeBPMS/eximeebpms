 ...
 */
public class EximeeBpmsFieldTest extends BpmnModelElementInstanceTest {
  ...
  public Collection<ChildElementAssumption> getChildElementAssumptions() {
    return Arrays.asList(
      new ChildElementAssumption(CAMUNDA_NS, EximeeBpmsExpression.class, 0, 1),
      new ChildElementAssumption(CAMUNDA_NS, EximeeBpmsString.class, 0, 1)
    );
  }
