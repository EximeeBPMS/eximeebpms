 ...
 */
public class EximeeBpmsMapImpl extends BpmnModelElementInstanceImpl implements EximeeBpmsMap {

  protected static ChildElementCollection<EximeeBpmsEntry> camundaEntryCollection;

  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(EximeeBpmsMap.class, BpmnModelConstants.CAMUNDA_ELEMENT_MAP)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(EximeeBpmsMapImpl::new);

    SequenceBuilder sequenceBuilder = typeBuilder.sequence();

    camundaEntryCollection = sequenceBuilder.elementCollection(EximeeBpmsEntry.class)
      .build();

    typeBuilder.build();
  }

  public EximeeBpmsMapImpl(ModelTypeInstanceContext instanceContext) {
