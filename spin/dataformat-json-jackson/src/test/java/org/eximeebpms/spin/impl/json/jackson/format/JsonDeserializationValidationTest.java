 ...
 */
package org.eximeebpms.spin.impl.json.jackson.format;
...
public class JsonDeserializationValidationTest {
  ...
  public void shouldValidateBaseTypeOnlyForComplexClass() {
    ...
    // then
    Mockito.verify(validator).validate("org.eximeebpms.spin.impl.json.jackson.format.JsonDeserializationValidationTest$Complex");
    Mockito.verifyNoMoreInteractions(validator);
  }
  ...
  public void shouldFailForComplexClass() {
    ...
    // then
    thrown.expect(SpinRuntimeException.class);
    thrown.expectMessage("[org.eximeebpms.spin.impl.json.jackson.format.JsonDeserializationValidationTest$Complex]");
