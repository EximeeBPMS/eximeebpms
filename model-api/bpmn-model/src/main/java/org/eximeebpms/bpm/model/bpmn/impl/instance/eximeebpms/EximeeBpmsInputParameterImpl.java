...
import static org.eximeebpms.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ELEMENT_INPUT_PARAMETER;
 ...
 */
public class EximeeBpmsInputParameterImpl extends EximeeBpmsGenericValueElementImpl implements EximeeBpmsInputParameter {

  protected static Attribute<String> camundaNameAttribute;

  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(EximeeBpmsInputParameter.class, CAMUNDA_ELEMENT_INPUT_PARAMETER)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(EximeeBpmsInputParameterImpl::new);
  ...
  public EximeeBpmsInputParameterImpl(ModelTypeInstanceContext instanceContext) {
