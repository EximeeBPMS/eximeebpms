...
public class EximeeBpmsFormUtils {

  private EximeeBpmsFormUtils() {
  }

  public static List<EximeeBpmsFormDefinition> findAllEximeeBpmsFormDefinitionEntities(ProcessEngineConfigurationImpl config) {
