...
import org.eximeebpms.bpm.spring.boot.starter.plugin.ApplicationContextClassloaderSwitchPlugin;
import org.eximeebpms.bpm.spring.boot.starter.spin.EximeeBPMSJacksonFormatConfiguratorJSR310;
import org.eximeebpms.bpm.spring.boot.starter.spin.EximeeBPMSJacksonFormatConfiguratorJdk8;
import org.eximeebpms.bpm.spring.boot.starter.spin.EximeeBPMSJacksonFormatConfiguratorParameterNames;
import org.eximeebpms.bpm.spring.boot.starter.spin.SpringBootSpinProcessEnginePlugin;
...
@Configuration
public class EximeeBPMSBpmPluginConfiguration {
  ...
  */
  ...
  static class SpinDataFormatConfigurationJSR310 {
    ...
    public static EximeeBPMSJacksonFormatConfiguratorJSR310 spinDataFormatConfiguratorJSR310() {
      return new EximeeBPMSJacksonFormatConfiguratorJSR310();
    }
  ...
  static class SpinDataFormatConfigurationParameterNames {
    ...
    public static EximeeBPMSJacksonFormatConfiguratorParameterNames spinDataFormatConfiguratorParameterNames() {
      return new EximeeBPMSJacksonFormatConfiguratorParameterNames();
    }
  ...
  static class SpinDataFormatConfigurationJdk8 {
    ...
    public static EximeeBPMSJacksonFormatConfiguratorJdk8 spinDataFormatConfiguratorJdk8() {
      return new EximeeBPMSJacksonFormatConfiguratorJdk8();
    }
