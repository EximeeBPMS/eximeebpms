 ...
 *
 */
public class AbstractEximeeBpmsFormFieldBuilder<P, B extends AbstractEximeeBpmsFormFieldBuilder<P, B>> 
  extends AbstractBpmnModelElementBuilder<B, EximeeBpmsFormField> {

  protected BaseElement parent;

  protected AbstractEximeeBpmsFormFieldBuilder(BpmnModelInstance modelInstance, BaseElement parent, EximeeBpmsFormField element, Class<?> selfType) {
