...
import org.eximeebpms.bpm.engine.rest.EventSubscriptionRestService;
import org.eximeebpms.bpm.engine.rest.ExecutionRestService;
import org.eximeebpms.bpm.engine.rest.ExternalTaskRestService;
import org.eximeebpms.bpm.engine.rest.FilterRestService;
...
import org.eximeebpms.bpm.engine.rest.JobDefinitionRestService;
import org.eximeebpms.bpm.engine.rest.JobRestService;
import org.eximeebpms.bpm.engine.rest.MessageRestService;
import org.eximeebpms.bpm.engine.rest.MetricsRestService;
import org.eximeebpms.bpm.engine.rest.MigrationRestService;
...
import org.eximeebpms.bpm.engine.rest.dto.ProcessEngineDto;
import org.eximeebpms.bpm.engine.rest.history.HistoryRestService;
import org.eximeebpms.bpm.engine.rest.impl.optimize.OptimizeRestService;
...
public class NamedProcessEngineRestServiceImpl extends AbstractProcessEngineRestServiceImpl {
  ...
  @Override
  @Path("/{name}" + ScriptSecurityRestService.PATH)
  public ScriptSecurityRestService getScriptSecurityRestService(@PathParam("name") String engineName) {
    return super.getScriptSecurityRestService(engineName);
  }
