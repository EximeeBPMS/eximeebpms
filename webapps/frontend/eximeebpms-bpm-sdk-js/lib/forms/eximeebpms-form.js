 ...
 */
function EximeebpmsForm(options) {
  if (!options) {
    throw new Error('EximeebpmsForm need to be initialized with options.');
  }
  ...
  if (!this.formElement && !this.containerElement) {
    return done(
      new Error(
        "EximeebpmsForm needs to be initilized with either 'formElement' or 'containerElement'",
      ),
    );
  }
 ...
 */
EximeebpmsForm.prototype.initializeHandler = function (FieldHandler) {
  var self = this;
 ...
 * @memberof CamSDK.form.CamundaForm.prototype
 */
EximeebpmsForm.prototype.initialize = function (done) {
  done =
    done ||
    function (err) {
      if (err) throw err;
 ...
 * @memberof CamSDK.form.CamundaForm.prototype
 */
EximeebpmsForm.prototype.renderForm = function (formHtmlSource) {
 ...
 * @memberof CamSDK.form.CamundaForm.prototype
 */
EximeebpmsForm.prototype.initializeForm = function (done) {
  var self = this;
...
EximeebpmsForm.prototype.initializeFieldHandlers = function () {
 ...
 * @memberof CamSDK.form.CamundaForm.prototype
 */
EximeebpmsForm.prototype.initializeFormScripts = function () {
...
EximeebpmsForm.prototype.executeFormScripts = function () {
  for (var i = 0; i < this.scripts.length; i++) {
    this.executeFormScript(this.scripts[i]);
  }
};

EximeebpmsForm.prototype.executeFormScript = function (script) {
  /*eslint-disable */
  /* jshint unused: false */
  (function(camForm) {
 ...
 * @memberof CamSDK.form.CamundaForm.prototype
 */
EximeebpmsForm.prototype.submit = function (callback) {
  var formId = this.taskId || this.processDefinitionId;
 ...
 * @memberof CamSDK.form.CamundaForm.prototype
 */
EximeebpmsForm.prototype.error = function (errorCode, errorMessage, callback) {
  var formId = this.taskId || this.processDefinitionId;
 ...
 * @memberof CamSDK.form.CamundaForm.prototype
 */
EximeebpmsForm.prototype.escalate = function (escalationCode, callback) {
  var formId = this.taskId || this.processDefinitionId;
...
EximeebpmsForm.prototype.transformFiles = function (callback) {
  var that = this;
  var counter = 1;
 ...
 * @memberof CamSDK.form.CamundaForm.prototype
 */
EximeebpmsForm.prototype.fetchVariables = function (done) {
  done = done || function () {};
 ...
 * @memberof CamSDK.form.CamundaForm.prototype
 */
EximeebpmsForm.prototype.parseVariables = function () {
 ...
 * @memberof CamSDK.form.CamundaForm.prototype
 */
EximeebpmsForm.prototype.submitVariables = function (done) {
  done = done || function () {};
 ...
 * @memberof CamSDK.form.CamundaForm.prototype
 */
EximeebpmsForm.prototype.storeOriginalValues = function (variables) {
 ...
 * @memberof CamSDK.form.CamundaForm.prototype
 */
EximeebpmsForm.prototype.mergeVariables = function (variables) {
  var vars = this.variableManager.variables;
 ...
 * @memberof CamSDK.form.CamundaForm.prototype
 */
EximeebpmsForm.prototype.applyVariables = function () {
  for (var i in this.fields) {
 ...
 * @memberof CamSDK.form.CamundaForm.prototype
 */
EximeebpmsForm.prototype.retrieveVariables = function () {
  for (var i in this.fields) {
 ...
 * @memberof CamSDK.form.CamundaForm.prototype
 */
EximeebpmsForm.prototype.fireEvent = function (eventName, obj) {
...
EximeebpmsForm.VariableManager = VariableManager;
EximeebpmsForm.fields = {};
EximeebpmsForm.fields.InputFieldHandler = InputFieldHandler;
EximeebpmsForm.fields.ChoicesFieldHandler = ChoicesFieldHandler;

/**
 * @memberof CamSDK.form.CamundaForm
 */
EximeebpmsForm.cleanLocalStorage = function (timestamp) {
 ...
 * @type {Function}
 */
EximeebpmsForm.extend = BaseClass.extend;

module.exports = EximeebpmsForm;
