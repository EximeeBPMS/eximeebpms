...
import org.eximeebpms.bpm.model.dmn.impl.DmnModelConstants;
...
public class DecisionDefinitionDeployerTest {
  ...
  @Deployment(resources = {
    "org/eximeebpms/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testDecisionDiagramResource.dmn11.xml",
    "org/eximeebpms/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testDecisionDiagramResource.png"
  })
  @Test
  ...
  @Deployment(resources = {
    "org/eximeebpms/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testMultipleDecisionDiagramResource.dmn11.xml",
    "org/eximeebpms/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testMultipleDecisionDiagramResource.decision1.png",
    "org/eximeebpms/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testMultipleDecisionDiagramResource.decision2.png",
    "org/eximeebpms/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testMultipleDecisionDiagramResource.decision3.png"
  })
  @Test
  ...
  public void testDeployDecisionDefinitionWithIntegerHistoryTimeToLive() {
    // when
    DeploymentWithDefinitions deployment = testRule.deploy("org/eximeebpms/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testDecisionDefinitionWithIntegerHistoryTimeToLive.dmn11.xml");
  ...
  public void testDeployDecisionDefinitionWithStringHistoryTimeToLive() {
    // when
    DeploymentWithDefinitions deployment = testRule.deploy("org/eximeebpms/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testDecisionDefinitionWithStringHistoryTimeToLive.dmn11.xml");
  ...
  public void testDeployDecisionDefinitionWithMalformedStringHistoryTimeToLive() {
    try {
      testRule.deploy("org/eximeebpms/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testDecisionDefinitionWithMalformedHistoryTimeToLive.dmn11.xml");
  ...
  public void testDeployDecisionDefinitionWithEmptyHistoryTimeToLive() {
      DeploymentWithDefinitions deployment = testRule.deploy("org/eximeebpms/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testDecisionDefinitionWithEmptyHistoryTimeToLive.dmn11.xml");
