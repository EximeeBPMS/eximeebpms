...
import org.eximeebpms.bpm.engine.impl.core.model.BaseCallableElement.CallableElementBinding;
...
import org.eximeebpms.bpm.engine.impl.jobexecutor.TimerEventJobHandler;
  ...
  protected XMLImporter getImporter(String importType, Element theImport) {
    if (this.importers.containsKey(importType)) {
      ...
      if (importType.equals("http://schemas.xmlsoap.org/wsdl/")) {
        ...
        try {
          wsdlImporterClass = Class.forName("org.eximeebpms.bpm.engine.impl.webservice.CxfWSDLImporter", true, Thread.currentThread().getContextClassLoader());
