...
import org.eximeebpms.bpm.engine.*;
...
import org.eximeebpms.bpm.engine.impl.repository.CalledProcessDefinitionImpl;
...
import org.eximeebpms.bpm.engine.repository.DeleteProcessDefinitionsBuilder;
import org.eximeebpms.bpm.engine.repository.DeleteProcessDefinitionsSelectBuilder;
...
import org.eximeebpms.bpm.engine.rest.helper.*;
...
import static org.eximeebpms.bpm.engine.rest.helper.MockProvider.createMockSerializedVariables;
...
public class ProcessDefinitionRestServiceInteractionTest extends AbstractRestServiceTest {
  ...
  private void setUpRuntimeDataForDefinition(ProcessDefinition mockDefinition) {
    ...
    when(runtimeServiceMock.startProcessInstanceById(eq(MockProvider.EXAMPLE_PROCESS_DEFINITION_ID), any(), any())).thenReturn(mockInstance);
...
//      .body("bpmn20Xml", startsWith("<?xml"))
  ...
  @Test
  public void testGetStartForm_shouldReturnEximeeBpmsFormRef() {
